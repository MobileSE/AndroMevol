...
public class DevicePolicyManager {
    ...
    public boolean installKeyPair(ComponentName who, PrivateKey privKey, Certificate cert, String alias) {
        try {
            return this.mService.installKeyPair(who, privKey.getEncoded(), Credentials.convertToPem(cert), alias);
        } catch (CertificateException e) {
    ...
    public void setTrustAgentFeaturesEnabled(ComponentName admin, ComponentName agent, List<String> features) {
        if (this.mService != null) {
            try {
