...
public class ActivityManager {
    ...
    public static boolean isHighEndGfx() {
        return !isLowRamDeviceStatic() && !Resources.getSystem().getBoolean(R.bool.config_avoidGfxAccel);
    }
    ...
    public static class RecentTaskInfo implements Parcelable {
        ...
        public void readFromParcel(Parcel source) {
            ...
            if (source.readInt() > 0) {
                taskDescription2 = TaskDescription.CREATOR.createFromParcel(source);
            } else {
    ...
    public static class TaskThumbnail implements Parcelable {
        public static final Parcelable.Creator<TaskThumbnail> CREATOR = new Parcelable.Creator<TaskThumbnail>() {
            /* class android.app.ActivityManager.TaskThumbnail.AnonymousClass1 */
    ...
    public int getLauncherLargeIconDensity() {
        ...
        switch (density) {
            ...
            case DisplayMetrics.DENSITY_XXHIGH /*{ENCODED_INT: 480}*/:
    ...
    private static void dumpService(java.io.PrintWriter r6, java.io.FileDescriptor r7, java.lang.String r8, java.lang.String[] r9) {
        /*
            java.lang.String r4 = "DUMP OF SERVICE "
            r6.print(r4)
            r6.print(r8)
            java.lang.String r4 = ":"
            r6.println(r4)
            android.os.IBinder r1 = android.os.ServiceManager.checkService(r8)
        ...
        L_0x0019:
            r2 = 0
            r6.flush()     // Catch:{ Throwable -> 0x0039 }
            com.android.internal.os.TransferPipe r3 = new com.android.internal.os.TransferPipe     // Catch:{ Throwable -> 0x0039 }
            r3.<init>()     // Catch:{ Throwable -> 0x0039 }
            java.lang.String r4 = "  "
            r3.setBufferPrefix(r4)     // Catch:{ Throwable -> 0x0048 }
            android.os.ParcelFileDescriptor r4 = r3.getWriteFd()     // Catch:{ Throwable -> 0x0048 }
            java.io.FileDescriptor r4 = r4.getFileDescriptor()     // Catch:{ Throwable -> 0x0048 }
            r1.dumpAsync(r4, r9)     // Catch:{ Throwable -> 0x0048 }
            r4 = 10000(0x2710, double:4.9407E-320)
            r3.go(r7, r4)     // Catch:{ Throwable -> 0x0048 }
            r2 = r3
            goto L_0x0018
        L_0x0039:
            r0 = move-exception
        L_0x003a:
            ...
            r2.kill()
        L_0x003f:
            java.lang.String r4 = "Failure dumping service:"
            r6.println(r4)
        ...
        L_0x0048:
            ...
            goto L_0x003a
        */
        throw new UnsupportedOperationException("Method not decompiled: android.app.ActivityManager.dumpService(java.io.PrintWriter, java.io.FileDescriptor, java.lang.String, java.lang.String[]):void");
    }
