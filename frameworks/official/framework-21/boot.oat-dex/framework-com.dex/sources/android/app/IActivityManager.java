...
public interface IActivityManager extends IInterface {
    ...
    public static final int GET_ACTIVITY_CONTAINER_TRANSACTION = 185;
    ...
    int checkUriPermission(Uri uri, int i, int i2, int i3, int i4) throws RemoteException;
    ...
    IActivityContainer getEnclosingActivityContainer(IBinder iBinder) throws RemoteException;
    ...
    public static class ContentProviderHolder implements Parcelable {
        public static final Parcelable.Creator<ContentProviderHolder> CREATOR = new Parcelable.Creator<ContentProviderHolder>() {
            /* class android.app.IActivityManager.ContentProviderHolder.AnonymousClass1 */
    ...
    public static class WaitResult implements Parcelable {
        public static final Parcelable.Creator<WaitResult> CREATOR = new Parcelable.Creator<WaitResult>() {
            /* class android.app.IActivityManager.WaitResult.AnonymousClass1 */
