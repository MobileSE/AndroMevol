...
public class Notification implements Parcelable {
    ...
    public static class Builder {
        ...
        private void shrinkLine3Text(RemoteViews contentView) {
            contentView.setTextViewTextSize(R.id.text, 0, (float) this.mContext.getResources().getDimensionPixelSize(R.dimen.notification_subtext_size));
        }

        private void unshrinkLine3Text(RemoteViews contentView) {
            contentView.setTextViewTextSize(R.id.text, 0, (float) this.mContext.getResources().getDimensionPixelSize(R.dimen.notification_text_size));
        }
        ...
        private RemoteViews applyStandardTemplate(int resId, boolean hasProgress) {
            ...
            if (this.mContentInfo != null) {
                ...
                if (this.mNumber > this.mContext.getResources().getInteger(17694723)) {
                    ...
                    contentView.setTextViewText(R.id.info, processLegacyText(NumberFormat.getIntegerInstance().format((long) this.mNumber)));
                }
                contentView.setViewVisibility(R.id.info, 0);
                showLine3 = true;
            } else {
            ...
            if (addProfileBadge(contentView, contentTextInLine2 ? R.id.profile_badge_line2 : R.id.profile_badge_line3) && !contentTextInLine2) {
                showLine3 = true;
            }
        ...
        private RemoteViews applyStandardTemplateWithActions(int layoutId) {
            ...
            if (N > 0) {
                ...
                for (int i = 0; i < N; i++) {
                    big.addView(R.id.actions, generateActionButton(this.mActions.get(i)));
                }
            }
            return big;
        }
        ...
        private int resolveColor() {
            if (this.mColor == 0) {
                return this.mContext.getResources().getColor(R.color.notification_icon_bg_color);
            }
            return this.mColor;
        }
    ...
    public static abstract class Style {
        ...
        public void applyTopPadding(RemoteViews contentView) {
            contentView.setViewPadding(R.id.line1, 0, Builder.calculateTopPadding(this.mBuilder.mContext, this.mBuilder.mHasThreeLines, this.mBuilder.mContext.getResources().getConfiguration().fontScale), 0, 0);
        }
    ...
    public static class BigPictureStyle extends Style {
        ...
        private RemoteViews makeBigContentView() {
            ...
            this.mBuilder.addProfileBadge(contentView, this.mBuilder.mSubText != null && this.mBuilder.mContentText != null ? R.id.profile_badge_line2 : R.id.profile_badge_line3);
            return contentView;
        }
    ...
    public static class InboxStyle extends Style {
        ...
        private RemoteViews makeBigContentView() {
            ...
            float subTextSize = (float) this.mBuilder.mContext.getResources().getDimensionPixelSize(R.dimen.notification_subtext_size);
            int i = 0;
    ...
    public static class MediaStyle extends Style {
        ...
        private RemoteViews generateMediaActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), (int) R.layout.notification_material_media_action);
