...
public final class ResourcesKey {
    ...
    public ResourcesKey(String resDir, int displayId, Configuration overrideConfiguration, float scale, IBinder token) {
        ...
        this.mScale = scale;
        this.mToken = token;
        this.mHash = (((((((this.mResDir == null ? 0 : this.mResDir.hashCode()) + 527) * 31) + this.mDisplayId) * 31) + (this.mOverrideConfiguration != null ? this.mOverrideConfiguration.hashCode() : i)) * 31) + Float.floatToIntBits(this.mScale);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((this.mResDir != peer.mResDir && (this.mResDir == null || peer.mResDir == null || !this.mResDir.equals(peer.mResDir))) || this.mDisplayId != peer.mDisplayId) {
            return false;
        }
