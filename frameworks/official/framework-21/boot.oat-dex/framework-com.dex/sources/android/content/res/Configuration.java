...
public final class Configuration implements Parcelable, Comparable<Configuration> {
    ...
    public void setLayoutDirection(Locale locale2) {
        this.screenLayout = (this.screenLayout & -193) | ((TextUtils.getLayoutDirectionFromLocale(locale2) + 1) << 6);
    }
    ...
    public static String localeToResourceQualifier(Locale locale2) {
        boolean l;
        boolean c;
        boolean s;
        boolean v;
        ...
        if (l) {
            ...
            if (c) {
                sb.append("-r").append(locale2.getCountry());
                if (s) {
                    sb.append("-s").append(locale2.getScript());
                    if (v) {
                        sb.append("-v").append(locale2.getVariant());
                    }
                }
            }
        }
    ...
    public static String resourceQualifierString(Configuration config) {
        ...
        switch (config.densityDpi) {
            ...
            case DisplayMetrics.DENSITY_XXHIGH /*{ENCODED_INT: 480}*/:
                parts.add("xxhdpi");
                break;
            case DisplayMetrics.DENSITY_XXXHIGH /*{ENCODED_INT: 640}*/:
                parts.add("xxxhdpi");
                break;
