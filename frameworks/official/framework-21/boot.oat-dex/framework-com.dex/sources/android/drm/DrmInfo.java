...
public class DrmInfo {
    ...
    public boolean isValid() {
        return this.mMimeType != null && !this.mMimeType.equals(ProxyInfo.LOCAL_EXCL_LIST) && this.mData != null && this.mData.length > 0 && DrmInfoRequest.isValidType(this.mInfoType);
    }
}
