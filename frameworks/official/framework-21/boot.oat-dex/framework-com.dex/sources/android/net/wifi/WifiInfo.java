...
public class WifiInfo implements Parcelable {
    ...
    public String toString() {
        ...
        Object obj = "<none>";
        StringBuffer append = sb.append("SSID: ").append(this.mWifiSsid == null ? WifiSsid.NONE : this.mWifiSsid).append(", BSSID: ").append(this.mBSSID == null ? obj : this.mBSSID).append(", MAC: ").append(this.mMacAddress == null ? obj : this.mMacAddress).append(", Supplicant state: ");
        if (this.mSupplicantState != null) {
            obj = this.mSupplicantState;
        }
        append.append(obj).append(", RSSI: ").append(this.mRssi).append(", Link speed: ").append(this.mLinkSpeed).append(LINK_SPEED_UNITS).append(", Frequency: ").append(this.mFrequency).append(FREQUENCY_UNITS).append(", Net ID: ").append(this.mNetworkId).append(", Metered hint: ").append(this.mMeteredHint).append(", score: ").append(Integer.toString(this.score));
        return sb.toString();
    }
