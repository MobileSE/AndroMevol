...
public final class Parcel {
    ...
    public final <T extends Parcelable> T readParcelable(ClassLoader loader) {
        ...
        return creator instanceof Parcelable.ClassLoaderCreator ? (T) ((Parcelable) ((Parcelable.ClassLoaderCreator) creator).createFromParcel(this, loader)) : creator.createFromParcel(this);
    }
        ...
        if (name != null) {
            synchronized (mCreators) {
                ...
                if (creator == null) {
                    ...
                    creator = (Parcelable.Creator) c.getField("CREATOR").get(null);
                    if (creator == null) {
                        throw new BadParcelableException("Parcelable protocol requires a Parcelable.Creator object called  CREATOR on class " + name);
                    }
    ...
    private void readSparseBooleanArrayInternal(SparseBooleanArray outVal, int N) {
        while (N > 0) {
            outVal.append(readInt(), readByte() == 1);
            N--;
        }
    }
}
