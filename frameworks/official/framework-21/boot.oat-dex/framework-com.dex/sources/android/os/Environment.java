...
public class Environment {
    ...
    public static String getExternalStorageState(File path) {
        ...
        if (volume != null) {
            try {
                return IMountService.Stub.asInterface(ServiceManager.getService("mount")).getVolumeState(volume.getPath());
    ...
    private static StorageVolume getStorageVolume(File path) {
        try {
            ...
            try {
                StorageVolume[] volumes = IMountService.Stub.asInterface(ServiceManager.getService("mount")).getVolumeList();
