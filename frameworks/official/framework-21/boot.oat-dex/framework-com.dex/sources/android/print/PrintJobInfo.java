...
public final class PrintJobInfo implements Parcelable {
    ...
    public String toString() {
        ...
        if (this.mDocumentInfo != null) {
            str = this.mDocumentInfo.toString();
        } else {
            str = null;
        }
        builder.append(append.append(str).toString());
        builder.append(", cancelling: " + this.mCanceling);
        StringBuilder append2 = new StringBuilder().append(", pages: ");
        if (this.mPageRanges != null) {
            str2 = Arrays.toString(this.mPageRanges);
        }
        builder.append(append2.append(str2).toString());
