...
public final class PrintAttributes implements Parcelable {
    ...
    public static final class MediaSize {
        ...
        public static final MediaSize NA_INDEX_5X8 = new MediaSize("NA_INDEX_5X8", "android", R.string.mediasize_na_index_5x8, BluetoothInputDevice.INPUT_DISCONNECT_FAILED_NOT_CONNECTED, 8000);
        public static final MediaSize NA_JUNIOR_LEGAL = new MediaSize("NA_JUNIOR_LEGAL", "android", R.string.mediasize_na_junior_legal, 8000, BluetoothInputDevice.INPUT_DISCONNECT_FAILED_NOT_CONNECTED);
