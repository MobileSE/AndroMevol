...
public class MtpDatabase {
    ...
    private int beginSendObject(String path, int format, int parent, int storageId, long size, long modified) {
        if (!inStorageRoot(path)) {
            ...
            if (path != null) {
                Cursor c = null;
                try {
                    Cursor c2 = this.mMediaProvider.query(this.mPackageName, this.mObjectsUri, ID_PROJECTION, PATH_WHERE, new String[]{path}, null, null);
    ...
    private int renameFile(int handle, String newName) {
        ...
        try {
            Cursor c2 = this.mMediaProvider.query(this.mPackageName, this.mObjectsUri, PATH_PROJECTION, ID_WHERE, whereArgs, null, null);
    ...
    private boolean getObjectInfo(int handle, int[] outStorageFormatParent, char[] outName, long[] outCreatedModified) {
        Cursor c = null;
        try {
            Cursor c2 = this.mMediaProvider.query(this.mPackageName, this.mObjectsUri, OBJECT_INFO_PROJECTION, ID_WHERE, new String[]{Integer.toString(handle)}, null, null);
            if (c2 == null || !c2.moveToNext()) {
                if (c2 != null) {
                    c2.close();
                }
    ...
    private int getObjectFilePath(int handle, char[] outFilePath, long[] outFileLengthFormat) {
        ...
        Cursor c = null;
        try {
            Cursor c2 = this.mMediaProvider.query(this.mPackageName, this.mObjectsUri, PATH_FORMAT_PROJECTION, ID_WHERE, new String[]{Integer.toString(handle)}, null, null);
            if (c2 != null && c2.moveToNext()) {
    ...
    private int deleteFile(int handle) {
        ...
        try {
            ...
            if (isStorageSubDirectory(path)) {
                ...
                if (this.mMediaProvider.delete(this.mPackageName, MediaStore.Files.getMtpObjectsUri(this.mVolumeName, (long) handle), null, null) > 0) {
    ...
    private int[] getObjectReferences(int handle) {
        Cursor c = null;
        try {
            Cursor c2 = this.mMediaProvider.query(this.mPackageName, MediaStore.Files.getMtpReferencesUri(this.mVolumeName, (long) handle), ID_PROJECTION, null, null, null, null);
            if (c2 == null) {
                if (c2 != null) {
                    c2.close();
                }
