...
public class DateUtils {
    ...
    public static CharSequence getRelativeDateTimeString(Context c, long time, long minResolution, long transitionResolution, int flags) {
        ...
        if (duration < transitionResolution) {
            return r.getString(R.string.relative_time, getRelativeTimeSpanString(time, now, minResolution, flags), timeClause);
        }
        return r.getString(R.string.date_time, getRelativeTimeSpanString(c, time, false), timeClause);
    }
