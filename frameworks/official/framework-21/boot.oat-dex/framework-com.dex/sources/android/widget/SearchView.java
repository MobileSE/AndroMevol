...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(a.getResourceId(1, R.layout.search_view), (ViewGroup) this, true);
    ...
    private void updateQueryHint() {
        if (this.mQueryHint != null) {
            ...
            this.mQueryTextView.setHint(getDecoratedHint(ProxyInfo.LOCAL_EXCL_LIST));
        }
    }
    ...
    private void onCloseClicked() {
        if (!TextUtils.isEmpty(this.mQueryTextView.getText())) {
            this.mQueryTextView.setText(ProxyInfo.LOCAL_EXCL_LIST);
