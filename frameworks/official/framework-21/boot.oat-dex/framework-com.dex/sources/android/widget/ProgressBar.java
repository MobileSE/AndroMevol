...
public class ProgressBar extends View {
    ...
    public void setProgressDrawable(Drawable d) {
        if (this.mProgressDrawable != d) {
            ...
            updateDrawableState();
            doRefreshProgress(16908301, (float) this.mProgress, false, false);
            doRefreshProgress(16908303, (float) this.mSecondaryProgress, false, false);
        }
    }
    ...
    public void setAnimationPosition(float position) {
        ...
        refreshProgress(16908301, position, true, true);
    }
    ...
    public synchronized void setProgress(int progress, boolean fromUser) {
        if (!this.mIndeterminate) {
            ...
            if (progress != this.mProgress) {
                this.mProgress = progress;
                refreshProgress(16908301, (float) this.mProgress, fromUser);
            }
        }
    }
    ...
    public synchronized void setSecondaryProgress(int secondaryProgress) {
        if (!this.mIndeterminate) {
            ...
            if (secondaryProgress != this.mSecondaryProgress) {
                ...
                refreshProgress(16908303, (float) this.mSecondaryProgress, false);
            }
        }
    }
    ...
    public synchronized void setMax(int max) {
        ...
        if (max != this.mMax) {
            ...
            refreshProgress(16908301, (float) this.mProgress, false);
        }
    }
