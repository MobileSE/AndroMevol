...
public class TimePickerSpinnerDelegate extends TimePicker.AbstractTimePickerDelegate implements RadialTimePickerView.OnValueSelectedListener {
    ...
    private final View.OnFocusChangeListener mFocusListener = new View.OnFocusChangeListener() {
        /* class android.widget.TimePickerSpinnerDelegate.AnonymousClass5 */
    ...
    public TimePickerSpinnerDelegate(TimePicker delegator, Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        View mainView = ((LayoutInflater) this.mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(a.getResourceId(9, R.layout.time_picker_holo), (ViewGroup) null);
    ...
    private void updateHeaderAmPm() {
        ...
        boolean amPmOnLeft = DateFormat.getBestDateTimePattern(this.mCurrentLocale, "hm").startsWith(FullBackup.APK_TREE_TOKEN);
    ...
    public static class SavedState extends View.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() {
            /* class android.widget.TimePickerSpinnerDelegate.SavedState.AnonymousClass1 */
