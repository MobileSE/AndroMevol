...
public class RemoteViews implements Parcelable, LayoutInflater.Filter {
    public static final Parcelable.Creator<RemoteViews> CREATOR = new Parcelable.Creator<RemoteViews>() {
        /* class android.widget.RemoteViews.AnonymousClass3 */
            ...
            if (target != null) {
                ...
                if (this.pendingIntent != null) {
                    listener = new View.OnClickListener() {
                        /* class android.widget.RemoteViews.SetOnClickPendingIntent.AnonymousClass1 */
    ...
    public class ViewGroupAction extends Action {
        ...
        public ViewGroupAction(int viewId, RemoteViews nestedViews2) {
            super();
            this.viewId = viewId;
            this.nestedViews = nestedViews2;
            if (nestedViews2 != null) {
                RemoteViews.this.configureRemoteViewsAsChild(nestedViews2);
            }
        }
    ...
    public View apply(Context context, ViewGroup parent, OnClickHandler handler) {
        ...
        LayoutInflater inflater = ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).cloneInContext(new ContextWrapper(context) {
