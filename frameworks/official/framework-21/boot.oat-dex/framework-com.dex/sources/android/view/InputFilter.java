...
public abstract class InputFilter extends IInputFilter.Stub {
    ...
    public InputFilter(Looper looper) {
        ...
        this.mOutboundInputEventConsistencyVerifier = InputEventConsistencyVerifier.isInstrumentationEnabled() ? new InputEventConsistencyVerifier(this, 1, "InputFilter#OutboundInputEventConsistencyVerifier") : inputEventConsistencyVerifier;
