                        ...
                        try {
                            ...
                            if (visible && this.mSurface.isValid()) {
                                if (!this.mSurfaceCreated && (surfaceChanged || visibleChanged)) {
                                    ...
                                    int len$2 = callbacks.length;
                                    for (int i$2 = 0; i$2 < len$2; i$2++) {
                                        callbacks[i$2].surfaceCreated(this.mSurfaceHolder);
                                    }
                                }
                                if (creating || formatChanged || sizeChanged || visibleChanged || realSizeChanged) {
                                    ...
                                    int len$3 = callbacks.length;
                                    for (int i$3 = 0; i$3 < len$3; i$3++) {
                                        callbacks[i$3].surfaceChanged(this.mSurfaceHolder, this.mFormat, myWidth, myHeight);
                                    }
                                }
                                if (redrawNeeded2) {
                                    if (callbacks == null) {
                                    ...
                                    int len$4 = callbacks.length;
                                    for (int i$4 = 0; i$4 < len$4; i$4++) {
                                        SurfaceHolder.Callback c = callbacks[i$4];
