...
public class MiniThumbFile {
    ...
    private String randomAccessFilePath(int version) {
        return (Environment.getExternalStorageDirectory().toString() + "/DCIM/.thumbnails") + "/.thumbdata" + version + NativeLibraryHelper.CLEAR_ABI_OVERRIDE + this.mUri.hashCode();
    }
    ...
    public synchronized long getMagic(long id) {
        ...
        if (miniThumbDataFile() != null) {
            ...
            try {
                ...
                FileLock lock2 = this.mChannel.lock(pos, 9, true);
