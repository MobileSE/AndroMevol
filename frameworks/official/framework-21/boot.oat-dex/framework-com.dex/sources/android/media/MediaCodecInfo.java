...
public final class MediaCodecInfo {
    ...
    public static final class AudioCapabilities {
        ...
        private void limitSampleRates(Range<Integer>[] rateRanges) {
            ...
            Range<Integer>[] arr$ = this.mSampleRateRanges;
            for (Range<Integer> range : arr$) {
        ...
        private void parseFromInfo(MediaFormat info) {
            ...
            if (info.containsKey("bitrate-range")) {
                bitRates = bitRates.intersect(Utils.parseIntRange(info.getString(MediaFormat.KEY_BIT_RATE), bitRates));
            }
    ...
    public static final class VideoCapabilities {
        ...
        private boolean supports(Integer width, Integer height, Double rate) {
            boolean ok;
            boolean ok2;
            boolean ok3 = true;
            if (!(1 == 0 || width == null)) {
                ok3 = this.mWidthRange.contains(width) && width.intValue() % this.mWidthAlignment == 0;
            }
            if (ok3 && height != null) {
            ...
            if (ok3 && rate != null) {
                ok3 = this.mFrameRateRange.contains(Utils.intRangeFor(rate.doubleValue()));
            }
            if (!ok3 || height == null || width == null) {
                return ok3;
            }
        ...
        public boolean supportsFormat(MediaFormat format) {
            Map<String, Object> map = format.getMap();
            return supports((Integer) map.get("width"), (Integer) map.get("height"), (Double) map.get(MediaFormat.KEY_FRAME_RATE));
        }
        ...
        private void parseFromInfo(MediaFormat info) {
            ...
            if (num.equals(map.get("feature-can-swap-width-height"))) {
                if (widths != null) {
                    this.mSmallerDimensionUpperLimit = Math.min(widths.getUpper().intValue(), heights.getUpper().intValue());
        ...
        private void updateLimits() {
            ...
            this.mBlockCountRange = this.mBlockCountRange.intersect(Range.create(Integer.valueOf(this.mVerticalBlockRange.getLower().intValue() * this.mHorizontalBlockRange.getLower().intValue()), Integer.valueOf(this.mVerticalBlockRange.getUpper().intValue() * this.mHorizontalBlockRange.getUpper().intValue())));
        ...
        private void applyLevelLimits() {
            ...
            if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_AVC)) {
                ...
                for (int i$ = 0; i$ < len$; i$++) {
                    ...
                    switch (profileLevel.level) {
                        ...
                        case 2:
                            ...
                            break;
                        case 4:
                            MBPS = ConnectivityManager.CONNECTIVITY_CHANGE_DELAY_DEFAULT;
                            FS = 396;
                            BR2 = 192;
                    ...
                    switch (profileLevel.profile) {
                        ...
                        case 8:
                            ...
                            break;
                        case 16:
                            BR = BR2 * ConnectivityManager.CONNECTIVITY_CHANGE_DELAY_DEFAULT;
                            break;
                        default:
                ...
                maxBps = 64000;
                int len$2 = profileLevels.length;
                for (int i$2 = 0; i$2 < len$2; i$2++) {
                    CodecProfileLevel profileLevel2 = profileLevels[i$2];
                    int MBPS2 = 0;
                    int FS2 = 0;
                    int BR3 = 0;
                    int FR = 0;
                        ...
                        case 32768:
                            switch (profileLevel2.level) {
                                ...
                                case 64:
                                    ...
                                    MBPS2 = 23760;
                                    FS2 = 792;
                                    BR3 = ConnectivityManager.CONNECTIVITY_CHANGE_DELAY_DEFAULT;
                                    break;
                                case 128:
                                    FR = 30;
                                    W = 45;
                ...
                applyMacroBlockLimits(maxWidth, maxHeight, maxBlocks2, (long) maxBlocksPerSecond2, 16, 16, 1, 1);
                ...
                maxBps = 64000;
                int len$3 = profileLevels.length;
                for (int i$3 = 0; i$3 < len$3; i$3++) {
                    CodecProfileLevel profileLevel3 = profileLevels[i$3];
                    int MBPS3 = 0;
                    int BR4 = 0;
                    int FR2 = 0;
                    int W2 = 0;
                ...
                applyMacroBlockLimits(maxWidth2, maxHeight2, maxBlocks3, (long) maxBlocksPerSecond3, 16, 16, 1, 1);
                ...
                maxBps = 100000000;
                int len$4 = profileLevels.length;
                for (int i$4 = 0; i$4 < len$4; i$4++) {
                    CodecProfileLevel profileLevel4 = profileLevels[i$4];
                ...
                applyMacroBlockLimits(32767, 32767, Integer.MAX_VALUE, (long) Integer.MAX_VALUE, blockSize, blockSize, 1, 1);
            } else if (mime.equalsIgnoreCase(MediaFormat.MIMETYPE_VIDEO_HEVC)) {
                int maxBlocks4 = 36864;
                int maxBlocksPerSecond4 = 36864 * 15;
                maxBps = 128000;
                int len$5 = profileLevels.length;
                for (int i$5 = 0; i$5 < len$5; i$5++) {
                    CodecProfileLevel profileLevel5 = profileLevels[i$5];
                    double FR3 = 0.0d;
                    int FS3 = 0;
                    int BR5 = 0;
                    switch (profileLevel5.level) {
                        ...
                        case 32:
                            FR3 = 30.0d;
                            FS3 = 245760;
                            BR5 = ConnectivityManager.CONNECTIVITY_CHANGE_DELAY_DEFAULT;
                            break;
                        case 64:
                        case 128:
                            FR3 = 30.0d;
                ...
                int maxLengthInBlocks2 = Utils.divUp((int) Math.sqrt((double) (maxBlocks4 * 8)), 8);
                applyMacroBlockLimits(maxLengthInBlocks2, maxLengthInBlocks2, maxBlocks5, (long) maxBlocksPerSecond5, 8, 8, 1, 1);
            } else {
                Log.w(TAG, "Unsupported mime " + mime);
                maxBps = 64000;
                errors = 4 | 2;
    ...
    public static final class EncoderCapabilities {
        ...
        private boolean supports(Integer complexity, Integer quality, Integer profile) {
            ...
            while (true) {
                if (i$ >= len$) {
                    break;
                } else if (arr$[i$].profile == profile.intValue()) {
                    profile = null;
                    break;
                } else {
                    i$++;
