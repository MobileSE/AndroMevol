...
public class Ringtone {
    ...
    public Ringtone(Context context, boolean allowRemote) {
        ...
        if (allowRemote) {
            iRingtonePlayer = this.mAudioManager.getRingtonePlayer();
        } else {
    ...
    private static String getTitle(Context context, Uri uri, boolean followSettingsUri) {
        ...
        if (uri != null) {
            ...
            if (!"settings".equals(authority)) {
                ...
                title = context.getString(R.string.ringtone_default_with_actual, getTitle(context, RingtoneManager.getActualDefaultRingtoneUri(context, RingtoneManager.getDefaultType(uri)), false));
            }
        }
