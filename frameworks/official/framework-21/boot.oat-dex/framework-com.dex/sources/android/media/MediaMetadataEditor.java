...
public abstract class MediaMetadataEditor {
    ...
    public synchronized int[] getEditableKeys() {
        return this.mEditableKeys == 268435457 ? new int[]{268435457} : null;
    }
            ...
            switch (METADATA_KEYS_TYPE.get(key, -1)) {
                case 0:
                    if (value instanceof Long) {
                        putBitmap = putLong(key, ((Long) value).longValue());
                        break;
                    } else {
                ...
                case 1:
                    if (value == null || (value instanceof String)) {
                        putBitmap = putString(key, (String) value);
                        break;
                    } else {
                ...
                case 2:
                    if (value == null || (value instanceof Bitmap)) {
                        putBitmap = putBitmap(key, (Bitmap) value);
                        break;
                    } else {
