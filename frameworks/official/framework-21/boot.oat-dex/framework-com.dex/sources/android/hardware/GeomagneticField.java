...
public class GeomagneticField {
    ...
    private static final long BASE_TIME = new GregorianCalendar(WindowManager.LayoutParams.TYPE_SYSTEM_ERROR, 1, 1).getTimeInMillis();
    ...
    private static final float[][] G_COEFF = {new float[]{0.0f}, new float[]{-29496.6f, -1586.3f}, new float[]{-2396.6f, 3026.1f, 1668.6f}, new float[]{1340.1f, -2326.2f, 1231.9f, 634.0f}, new float[]{912.6f, 808.9f, 166.7f, -357.1f, 89.4f}, new float[]{-230.9f, 357.2f, 200.3f, -141.1f, -163.0f, -7.8f}, new float[]{72.8f, 68.6f, 76.0f, -141.4f, -22.8f, 13.2f, -77.9f}, new float[]{80.5f, -75.1f, -4.7f, 45.3f, 13.9f, 10.4f, 1.7f, 4.9f}, new float[]{24.4f, 8.1f, -14.5f, -5.6f, -19.3f, 11.5f, 10.9f, -14.1f, -3.7f}, new float[]{5.4f, 9.4f, 3.4f, -5.2f, 3.1f, -12.4f, -0.7f, 8.4f, -8.5f, -10.1f}, new float[]{-2.0f, -6.3f, 0.9f, -1.1f, -0.2f, 2.5f, -0.3f, 2.2f, 3.1f, -1.0f, -2.8f}, new float[]{3.0f, -1.5f, -2.1f, 1.7f, -0.5f, 0.5f, -0.8f, 0.4f, 1.8f, 0.1f, 0.7f, 3.8f}, new float[]{-2.2f, -0.2f, 0.3f, 1.0f, -0.6f, 0.9f, -0.1f, 0.5f, -0.4f, -0.4f, 0.2f, -0.8f, 0.0f}};
    ...
    private static float[][] computeSchmidtQuasiNormFactors(int maxN) {
        ...
        for (int n = 1; n <= maxN; n++) {
            ...
            for (int m = 1; m <= n; m++) {
                int i = (n - m) + 1;
                schmidtQuasiNorm[n][m] = ((float) Math.sqrt((double) (((float) ((m == 1 ? 2 : 1) * i)) / ((float) (n + m))))) * schmidtQuasiNorm[n][m - 1];
            }
        }
