...
public abstract class CameraMetadata<TKey> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r13v0, resolved type: android.hardware.camera2.CameraMetadata<TKey> */
    /* JADX DEBUG: Multi-variable search result rejected for r6v0, resolved type: java.util.ArrayList<TKey> */
        ...
        for (Field field : fields) {
            if (field.getType().isAssignableFrom(keyClass) && (field.getModifiers() & 1) != 0) {
                try {
                    ...
                    if (instance == 0 || instance.getProtected(obj) != null) {
                        if (shouldKeyBeAdded(obj, field, filterTags)) {
                            keyList.add(obj);
                            if (VERBOSE) {
    ...
    private static <TKey> boolean shouldKeyBeAdded(TKey key, Field field, int[] filterTags) {
        ...
        return filterTags == null || field.getAnnotation(SyntheticKey.class) != null || Arrays.binarySearch(filterTags, nativeKey.getTag()) >= 0;
    }
}
