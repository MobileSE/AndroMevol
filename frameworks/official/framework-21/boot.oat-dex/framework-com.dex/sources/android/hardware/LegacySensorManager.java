...
public final class LegacySensorManager {
    ...
    public boolean registerListener(SensorListener listener, int sensors, int rate) {
        ...
        boolean result5 = registerLegacyListener(2, 1, listener, sensors, rate) || 0 != 0;
        if (registerLegacyListener(8, 2, listener, sensors, rate) || result5) {
            result = true;
        } else {
            result = false;
        }
        ...
        if (registerLegacyListener(1, 3, listener, sensors, rate) || result2) {
            result3 = true;
        } else {
            result3 = false;
        }
        if (registerLegacyListener(4, 7, listener, sensors, rate) || result3) {
            result4 = true;
        } else {
            result4 = false;
        }
