...
public class Canvas {
    ...
    public boolean clipRect(Rect rect) {
        return native_clipRect(this.mNativeCanvasWrapper, (float) rect.left, (float) rect.top, (float) rect.right, (float) rect.bottom, Region.Op.INTERSECT.nativeInt);
    }
    ...
    public boolean clipRect(int left, int top, int right, int bottom) {
        return native_clipRect(this.mNativeCanvasWrapper, (float) left, (float) top, (float) right, (float) bottom, Region.Op.INTERSECT.nativeInt);
    }
    ...
    public void drawTextRun(CharSequence text, int start, int end, int contextStart, int contextEnd, float x, float y, boolean isRtl, Paint paint) {
        if (text == null) {
            ...
            native_drawTextRun(this.mNativeCanvasWrapper, buf, start - contextStart, end - start, 0, contextLen, x, y, isRtl, paint.mNativePaint, paint.mNativeTypeface);
            TemporaryBuffer.recycle(buf);
        }
    }
