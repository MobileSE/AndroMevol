...
public final class UlawEncoderInputStream extends InputStream {
    ...
    public static void encode(byte[] pcmBuf, int pcmOffset, byte[] ulawBuf, int ulawOffset, int length, int max) {
        ...
        while (i < length) {
            ...
            int pcm = (((pcmBuf[pcmOffset2] & BatteryStats.HistoryItem.CMD_NULL) + (pcmBuf[pcmOffset3] << 8)) * coef) >> 16;
            if (pcm >= 0) {
                ulaw = pcm <= 0 ? 255 : pcm <= 30 ? ((30 - pcm) >> 1) + 240 : pcm <= 94 ? ((94 - pcm) >> 2) + 224 : pcm <= 222 ? ((222 - pcm) >> 3) + 208 : pcm <= 478 ? ((478 - pcm) >> 4) + 192 : pcm <= 990 ? ((990 - pcm) >> 5) + 176 : pcm <= 2014 ? ((2014 - pcm) >> 6) + 160 : pcm <= 4062 ? ((4062 - pcm) >> 7) + 144 : pcm <= 8158 ? ((8158 - pcm) >> 8) + 128 : 128;
            } else if (-1 <= pcm) {
                ulaw = 127;
            } else {
                ulaw = -31 <= pcm ? ((pcm + 31) >> 1) + 112 : -95 <= pcm ? ((pcm + 95) >> 2) + 96 : -223 <= pcm ? ((pcm + 223) >> 3) + 80 : -479 <= pcm ? ((pcm + 479) >> 4) + 64 : -991 <= pcm ? ((pcm + 991) >> 5) + 48 : -2015 <= pcm ? ((pcm + WindowManager.LayoutParams.TYPE_SECURE_SYSTEM_OVERLAY) >> 6) + 32 : -4063 <= pcm ? ((pcm + 4063) >> 7) + 16 : -8159 <= pcm ? ((pcm + 8159) >> 8) + 0 : 0;
            }
    ...
    public static int maxAbsPcm(byte[] pcmBuf, int offset, int length) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            offset2 = offset3 + 1;
            int pcm = (pcmBuf[offset2] & BatteryStats.HistoryItem.CMD_NULL) + (pcmBuf[offset3] << 8);
            if (pcm < 0) {
                pcm = -pcm;
            }
            if (pcm > max) {
