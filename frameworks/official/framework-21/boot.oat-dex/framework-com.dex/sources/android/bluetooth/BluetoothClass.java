    ...
    public boolean doesClassMatch(int profile) {
        if (profile == 1) {
            ...
            switch (getDeviceClass()) {
                case Device.AUDIO_VIDEO_LOUDSPEAKER /*{ENCODED_INT: 1044}*/:
                case Device.AUDIO_VIDEO_HEADPHONES /*{ENCODED_INT: 1048}*/:
                case Device.AUDIO_VIDEO_CAR_AUDIO /*{ENCODED_INT: 1056}*/:
                case Device.AUDIO_VIDEO_HIFI_AUDIO /*{ENCODED_INT: 1064}*/:
                    return true;
                default:
                    return false;
            }
            ...
            switch (getDeviceClass()) {
                ...
                case 512:
                case 516:
                case Device.PHONE_CORDLESS /*{ENCODED_INT: 520}*/:
                case Device.PHONE_SMART /*{ENCODED_INT: 524}*/:
                case Device.PHONE_MODEM_OR_GATEWAY /*{ENCODED_INT: 528}*/:
                case Device.PHONE_ISDN /*{ENCODED_INT: 532}*/:
                    return true;
                default:
                    return false;
            }
