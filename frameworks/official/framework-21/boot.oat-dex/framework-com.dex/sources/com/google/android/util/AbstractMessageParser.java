...
public abstract class AbstractMessageParser {
    ...
    public static Token tokenForUrl(String url, String text2) {
        ...
        return flickrPhoto != null ? flickrPhoto : new Link(url, text2);
    }
    ...
    public static class FlickrPhoto extends Token {
        ...
        public FlickrPhoto(String user2, String photo2, String grouping2, String groupingId2, String text) {
            ...
            if (!"tags".equals(user2)) {
                this.user = user2;
                this.photo = HardwareRenderer.OVERDRAW_PROPERTY_SHOW.equals(photo2) ? null : photo2;
    ...
    public String toHtml() {
        ...
        while (it.hasNext()) {
            boolean caps = false;
            html.append("<p>");
            Iterator i$ = it.next().getTokens().iterator();
            while (i$.hasNext()) {
                Token token = i$.next();
                if (token.isHtml()) {
