...
public class TelephonyIntents {
    ...
    public static final String ACTION_SIMINFO_CONTENT_CHANGE = "android.intent.action.ACTION_SIMINFO_CONTENT_CHANGE";
    public static final String ACTION_SIMINFO_UPDATED = "android.intent.action.ACTION_SIMINFO_UPDATED";
