...
public class XmlUtils {
    ...
    public static final void writeByteArrayXml(byte[] val, String name, XmlSerializer out) throws XmlPullParserException, IOException {
        ...
        for (byte b : val) {
            ...
            int h2 = b & BatteryStats.HistoryItem.CMD_NULL;
        ...
        if (tagName.equals("null")) {
            ...
            if (res == null) {
                if (tagName.equals("int-array")) {
                    ...
                    parser.next();
                    Object res6 = readThisMapXml(parser, "map", name);
                    name[0] = valueName;
                    return res6;
                } else if (tagName.equals("list")) {
                    parser.next();
                    Object res7 = readThisListXml(parser, "list", name);
                    name[0] = valueName;
                    return res7;
                } else if (tagName.equals("set")) {
                    parser.next();
                    Object res8 = readThisSetXml(parser, "set", name);
                    name[0] = valueName;
                    return res8;
                } else if (callback != null) {
                    Object res9 = callback.readThisUnknownObjectXml(parser, tagName);
                    name[0] = valueName;
                    return res9;
                } else {
