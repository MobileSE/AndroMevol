...
public class HeavyWeightSwitcherActivity extends Activity {
    ...
    private View.OnClickListener mCancelListener = new View.OnClickListener() {
        /* class com.android.internal.app.HeavyWeightSwitcherActivity.AnonymousClass3 */
    ...
    /* access modifiers changed from: package-private */
    public void setIconAndText(int iconId, int actionId, int descriptionId, String packageName, int actionStr, int descriptionStr) {
