...
public class SlidingTab extends ViewGroup {
    ...
    public static class Slider {
        ...
        public void layout(int l, int t, int r, int b, int alignment2) {
            ...
            int top2 = (((int) (SlidingTab.THRESHOLD * ((float) parentHeight))) + (handleHeight / 2)) - targetHeight;
            int bottom2 = ((int) (0.3333333f * ((float) parentHeight))) - (handleHeight / 2);
            if (alignment2 == 2) {
    ...
    public void startAnimating(final boolean holdAfter) {
        ...
        if (isHorizontal()) {
            ...
            dx = slider == this.mRightSlider ? -((right + viewWidth) - holdOffset2) : ((viewWidth - left) + viewWidth) - holdOffset2;
            dy = 0;
        } else {
