...
public class SizeAdaptiveLayout extends ViewGroup {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(resolveSizeAndState(childWidth, widthMeasureSpec, childState), clampSizeToBounds(resolveSizeAndState(childHeight, heightMeasureSpec, childState), model));
    }
    ...
    private View selectActiveChild(int heightMeasureSpec) {
        ...
        return (heightMode == 0 || heightSize > tallestViewSize) ? tallestView : smallestView;
    }
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        this.mActiveChild = selectActiveChild(View.MeasureSpec.makeMeasureSpec(bottom - top, 1073741824));
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        public LayoutParams(int width, int height, int minHeight2, int maxHeight2) {
            super(width, height);
    ...
    public class BringToFrontOnEnd implements Animator.AnimatorListener {
        static final /* synthetic */ boolean $assertionsDisabled = (!SizeAdaptiveLayout.class.desiredAssertionStatus());
