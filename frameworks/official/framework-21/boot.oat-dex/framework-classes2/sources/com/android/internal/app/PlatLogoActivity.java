...
public class PlatLogoActivity extends Activity {
    ...
    public Drawable makeRipple() {
        ...
        return new RippleDrawable(ColorStateList.valueOf(FLAVORS[idx + 1]), popbg, null);
    }
        ...
        im.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (PlatLogoActivity.this.mTapCount == 0) {
                    ...
                    ObjectAnimator a = ObjectAnimator.ofInt(platlogo, "alpha", 0, R.styleable.Theme_actionBarTheme);
                    ...
                    im.setOnLongClickListener(new View.OnLongClickListener() {
                        ...
                        public boolean onLongClick(View v) {
                            ...
                            if (Settings.System.getLong(cr, "egg_mode", 0) == 0) {
