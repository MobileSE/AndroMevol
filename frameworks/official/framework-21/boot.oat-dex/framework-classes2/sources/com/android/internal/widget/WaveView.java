...
public class WaveView extends View implements ValueAnimator.AnimatorUpdateListener {
    ...
    public WaveView(Context context, AttributeSet attrs) {
        ...
        this.mSnapRadius = R.styleable.Theme_actionModeBackground;
        this.mWaveCount = 20;
        ...
        this.mAddWaveAction = new Runnable() {
            ...
            public void run() {
                ...
                if (WaveView.this.mLockState != 3 || dragDistance >= WaveView.this.mSnapRadius || WaveView.this.mWaveTimerDelay < 100) {
                    ...
                    wave.addAnimTo(1333, 0, "alpha", WaveView.GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, true);
                    wave.addAnimTo(WaveView.WAVE_DURATION, 0, "scaleX", WaveView.GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, true);
                    wave.addAnimTo(WaveView.WAVE_DURATION, 0, "scaleY", WaveView.GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, true);
    ...
    private void waveUpdateFrame(float mouseX, float mouseY, boolean fingerDown) {
        ...
        switch (this.mLockState) {
            case 0:
                ...
                this.mUnlockDefault.setScaleY(0.1f);
                this.mUnlockDefault.setAlpha(0.0f);
                this.mUnlockDefault.addAnimTo(DURATION, 100, "scaleX", GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, true);
                this.mUnlockDefault.addAnimTo(DURATION, 100, "scaleY", GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, true);
                this.mUnlockDefault.addAnimTo(DURATION, 100, "alpha", GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, true);
                ...
                this.mUnlockHalo.addAnimTo(DURATION, 100, "scaleX", GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, true);
                this.mUnlockHalo.addAnimTo(DURATION, 100, "scaleY", GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, true);
                this.mUnlockHalo.addAnimTo(DURATION, 100, "alpha", GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, true);
            ...
            case 2:
                ...
                this.mUnlockDefault.setScaleY(0.1f);
                this.mUnlockDefault.setAlpha(0.0f);
                this.mUnlockDefault.addAnimTo(DURATION, 100, "scaleX", GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, false);
                this.mUnlockDefault.addAnimTo(DURATION, 100, "scaleY", GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, false);
                this.mUnlockDefault.addAnimTo(DURATION, 100, "alpha", GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, false);
                this.mUnlockRing.addAnimTo(DURATION, 0, "scaleX", GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, true);
                this.mUnlockRing.addAnimTo(DURATION, 0, "scaleY", GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, true);
                this.mUnlockRing.addAnimTo(DURATION, 0, "alpha", GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, true);
                this.mLockState = 3;
                break;
            case 3:
                if (dragDistance > this.mSnapRadius) {
                    ...
                    if (fingerDown) {
                        ...
                        this.mUnlockHalo.addAnimTo(0, 0, "scaleX", GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, true);
                        this.mUnlockHalo.addAnimTo(0, 0, "scaleY", GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, true);
                        this.mUnlockHalo.addAnimTo(0, 0, "alpha", GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, true);
                        break;
                    } else {
                        this.mLockState = 4;
                        break;
            ...
            case 4:
                if (dragDistance > this.mSnapRadius) {
                    ...
                    this.mUnlockDefault.addAnimTo(200, 0, "scaleX", GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, true);
                    this.mUnlockDefault.addAnimTo(200, 0, "scaleY", GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, true);
                    this.mUnlockDefault.addAnimTo(200, 0, "alpha", GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED, true);
    ...
    private float getScaledGrabHandleRadius() {
        if (AccessibilityManager.getInstance(this.mContext).isEnabled()) {
            return GRAB_HANDLE_RADIUS_SCALE_ACCESSIBILITY_ENABLED * ((float) this.mUnlockHalo.getWidth());
        }
