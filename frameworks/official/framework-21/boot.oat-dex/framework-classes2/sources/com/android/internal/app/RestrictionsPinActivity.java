...
public class RestrictionsPinActivity extends AlertActivity implements View.OnClickListener, TextWatcher, TextView.OnEditorActionListener {
    ...
    @Override // com.android.internal.app.AlertActivity
    ...
    public void initUi() {
        ...
        ap.mView = ((LayoutInflater) getSystemService("layout_inflater")).inflate(R.layout.restrictions_pin_challenge, (ViewGroup) null);
    ...
    private boolean updatePinTimer(int pinTimerMs) {
        ...
        if (pinTimerMs >= 200) {
            if (pinTimerMs <= 60000) {
                int seconds = (pinTimerMs + R.styleable.Theme_colorActivatedHighlight) / 1000;
