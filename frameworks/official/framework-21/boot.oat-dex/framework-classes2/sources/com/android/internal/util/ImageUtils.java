...
public class ImageUtils {
    ...
    public static boolean isGrayscale(int color) {
        if (((color >> 24) & R.styleable.Theme_actionBarTheme) < 50) {
            return true;
        }
        int r = (color >> 16) & R.styleable.Theme_actionBarTheme;
        int g = (color >> 8) & R.styleable.Theme_actionBarTheme;
        int b = color & R.styleable.Theme_actionBarTheme;
