...
public final class ProcessStats implements Parcelable {
    ...
    static int OFFSET_ARRAY_MASK = R.styleable.Theme_actionBarTheme;
    static int OFFSET_ARRAY_SHIFT = 8;
    static int OFFSET_INDEX_MASK = 65535;
    static int OFFSET_INDEX_SHIFT = 16;
    static int OFFSET_TYPE_MASK = R.styleable.Theme_actionBarTheme;
    ...
    static final String[] STATE_TAGS = {"p", "t", "f", "b", "u", "w", "s", "x", "r", "h", "l", "a", "c", "e"};
