...
public class IntentForwarderActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (canForward) {
            ...
            boolean shouldShowDisclosure = !UserHandle.isSameApp(getPackageManager().resolveActivityAsUser(newIntent, Protocol.BASE_SYSTEM_RESERVED, userDest.getIdentifier()).activityInfo.applicationInfo.uid, 1000);
            try {
