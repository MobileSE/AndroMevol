        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    if (data.readInt() != 0) {
                        _arg14 = (EditorInfo) EditorInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg14 = null;
                    }
                ...
                case 5:
                    ...
                    if (data.readInt() != 0) {
                        _arg13 = (EditorInfo) EditorInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg13 = null;
                    }
                ...
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg02 = (InputChannel) InputChannel.CREATOR.createFromParcel(data);
                    } else {
                        _arg02 = null;
                    }
