        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    if (data.readInt() != 0) {
                        _arg07 = (ServiceState) ServiceState.CREATOR.createFromParcel(data);
                    } else {
                        _arg07 = null;
                    }
                    onServiceStateChanged(_arg07);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 3:
                    ...
                    onMessageWaitingIndicatorChanged(_arg08);
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    onCallForwardingIndicatorChanged(_arg08);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                ...
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg05 = (SignalStrength) SignalStrength.CREATOR.createFromParcel(data);
                    } else {
                        _arg05 = null;
                    }
                ...
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg03 = (PreciseDataConnectionState) PreciseDataConnectionState.CREATOR.createFromParcel(data);
                    } else {
                        _arg03 = null;
                    }
