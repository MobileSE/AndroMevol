...
public class FastPrintWriter extends PrintWriter {
    private static Writer sDummyWriter = new Writer() {
        /* class com.android.internal.util.FastPrintWriter.AnonymousClass1 */
    ...
    public FastPrintWriter(OutputStream out) {
        this(out, false, (int) MtpConstants.RESPONSE_UNDEFINED);
    }

    public FastPrintWriter(OutputStream out, boolean autoFlush) {
        this(out, autoFlush, (int) MtpConstants.RESPONSE_UNDEFINED);
    }
    ...
    public FastPrintWriter(Writer wr) {
        this(wr, false, (int) MtpConstants.RESPONSE_UNDEFINED);
    }

    public FastPrintWriter(Writer wr, boolean autoFlush) {
        this(wr, autoFlush, (int) MtpConstants.RESPONSE_UNDEFINED);
    }
