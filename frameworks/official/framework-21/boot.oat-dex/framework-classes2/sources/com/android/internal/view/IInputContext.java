        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg06 = (ExtractedTextRequest) ExtractedTextRequest.CREATOR.createFromParcel(data);
                    } else {
                        _arg06 = null;
                    }
                    getExtractedText(_arg06, data.readInt(), data.readInt(), IInputContextCallback.Stub.asInterface(data.readStrongBinder()));
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 6:
                    ...
                    setComposingText(_arg05, data.readInt());
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    finishComposingText();
                ...
                case 8:
                    ...
                    commitText(_arg04, data.readInt());
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                ...
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg02 = (CorrectionInfo) CorrectionInfo.CREATOR.createFromParcel(data);
                    } else {
                        _arg02 = null;
                    }
                ...
                case 19:
                    ...
                    performPrivateCommand(_arg07, _arg1);
                    return true;
                case 20:
                    data.enforceInterface(DESCRIPTOR);
