...
public class ProcessCpuTracker {
    ...
    private static final int[] SYSTEM_CPU_FORMAT = {R.styleable.Theme_ambientShadowAlpha, MtpConstants.RESPONSE_SPECIFICATION_OF_DESTINATION_UNSUPPORTED, MtpConstants.RESPONSE_SPECIFICATION_OF_DESTINATION_UNSUPPORTED, MtpConstants.RESPONSE_SPECIFICATION_OF_DESTINATION_UNSUPPORTED, MtpConstants.RESPONSE_SPECIFICATION_OF_DESTINATION_UNSUPPORTED, MtpConstants.RESPONSE_SPECIFICATION_OF_DESTINATION_UNSUPPORTED, MtpConstants.RESPONSE_SPECIFICATION_OF_DESTINATION_UNSUPPORTED, MtpConstants.RESPONSE_SPECIFICATION_OF_DESTINATION_UNSUPPORTED};
        ...
        while (true) {
            ...
            if (st != null && st.pid == pid) {
                ...
                if (Process.readProcFile(st2.statFile.toString(), PROCESS_FULL_STATS_FORMAT, procStatsString, procStats2, null)) {
                    ...
                    st2.baseName = "<unknown>";
                    st2.base_stime = 0;
                    st2.base_utime = 0;
                    st2.base_majfaults = 0;
                    st2.base_minfaults = 0;
                }
                if (parentPid < 0) {
    ...
    public final String printCurrentState(long now) {
        ...
        long percAwake = sampleRealTime > 0 ? (100 * sampleTime) / sampleRealTime : 0;
        if (percAwake != 100) {
            pw.print(" with ");
            pw.print(percAwake);
            pw.print("% awake");
        ...
        for (int i = 0; i < N; i++) {
            ...
            if (!st.removed && st.workingThreads != null) {
                ...
                for (int j = 0; j < M; j++) {
                    ...
                    printProcessCPU(pw, str, tst.pid, tst.name, ((int) (st.rel_uptime + 5)) / 10, tst.rel_utime, tst.rel_stime, 0, 0, 0, 0, 0);
                }
            }
        }
    ...
    private java.lang.String readFile(java.lang.String r9, char r10) {
        /*
        // Method dump skipped, instructions count: 111
        */
        throw new UnsupportedOperationException("Method not decompiled: com.android.internal.os.ProcessCpuTracker.readFile(java.lang.String, char):java.lang.String");
    }
