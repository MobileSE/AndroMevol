        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg015 = (WorkSource) WorkSource.CREATOR.createFromParcel(data);
                    } else {
                        _arg015 = null;
                    }
                ...
                case 21:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg014 = (WorkSource) WorkSource.CREATOR.createFromParcel(data);
                    } else {
                        _arg014 = null;
                    }
                ...
                case 22:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg013 = (WorkSource) WorkSource.CREATOR.createFromParcel(data);
                    } else {
                        _arg013 = null;
                    }
                ...
                case 36:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg012 = (SignalStrength) SignalStrength.CREATOR.createFromParcel(data);
                    } else {
                        _arg012 = null;
                    }
                ...
                case 41:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg011 = (WorkSource) WorkSource.CREATOR.createFromParcel(data);
                    } else {
                        _arg011 = null;
                    }
                ...
                case 42:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg010 = (WorkSource) WorkSource.CREATOR.createFromParcel(data);
                    } else {
                        _arg010 = null;
                    }
                    if (data.readInt() != 0) {
                ...
                case 43:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg09 = (WorkSource) WorkSource.CREATOR.createFromParcel(data);
                    } else {
                        _arg09 = null;
                    }
                ...
                case 56:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg08 = (WorkSource) WorkSource.CREATOR.createFromParcel(data);
                    } else {
                        _arg08 = null;
                    }
                ...
                case 58:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg06 = (WorkSource) WorkSource.CREATOR.createFromParcel(data);
                    } else {
                        _arg06 = null;
                    }
                ...
                case 60:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg04 = (WorkSource) WorkSource.CREATOR.createFromParcel(data);
                    } else {
                        _arg04 = null;
                    }
                ...
                case 62:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg02 = (WorkSource) WorkSource.CREATOR.createFromParcel(data);
                    } else {
                        _arg02 = null;
                    }
