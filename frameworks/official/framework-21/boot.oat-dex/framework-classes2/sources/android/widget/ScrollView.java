...
public class ScrollView extends FrameLayout {
        ...
        if (canScroll()) {
            ...
            if (event.getAction() == 0) {
                switch (event.getKeyCode()) {
                    ...
                    case 20:
                        if (event.isAltPressed()) {
                            handled = fullScroll(R.styleable.Theme_textSelectHandleWindowStyle);
                            break;
                        } else {
                            handled = arrowScroll(R.styleable.Theme_textSelectHandleWindowStyle);
                            break;
                        }
                    case 62:
            ...
            View nextFocused = FocusFinder.getInstance().findNextFocus(this, currentFocused, R.styleable.Theme_textSelectHandleWindowStyle);
            if (nextFocused == null || nextFocused == this || !nextFocused.requestFocus(R.styleable.Theme_textSelectHandleWindowStyle)) {
                return false;
            }
            return true;
        }
    ...
    public boolean onRequestFocusInDescendants(int direction, Rect previouslyFocusedRect) {
        if (direction == 2) {
            direction = R.styleable.Theme_textSelectHandleWindowStyle;
        } else if (direction == 1) {
            direction = 33;
        }
