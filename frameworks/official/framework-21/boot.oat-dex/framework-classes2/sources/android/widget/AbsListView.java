...
public abstract class AbsListView extends AdapterView<ListAdapter> implements TextWatcher, ViewTreeObserver.OnGlobalLayoutListener, Filter.FilterListener, ViewTreeObserver.OnTouchModeChangeListener, RemoteViewsAdapter.RemoteAdapterConnectionCallback {
    ...
    public boolean performAccessibilityAction(int action, Bundle arguments) {
        ...
        switch (action) {
            case 4096:
                ...
                smoothScrollBy((getHeight() - this.mListPadding.top) - this.mListPadding.bottom, R.styleable.Theme_colorActivatedHighlight);
                return true;
                    ...
                    if (!AbsListView.this.mDataChanged) {
                        ...
                        if (longClickable) {
                            if (AbsListView.this.mPendingCheckForLongPress == null) {
                                AbsListView.this.mPendingCheckForLongPress = new CheckForLongPress(AbsListView.this, (AnonymousClass1) null);
                            }
    ...
    private void scrollIfNeeded(int x, int y, MotionEvent vtev) {
        ...
        if (this.mTouchMode == 3) {
            ...
            if (y != this.mLastY) {
                if ((this.mGroupFlags & Protocol.BASE_CONNECTIVITY_MANAGER) == 0 && Math.abs(rawDeltaY) > this.mTouchSlop && (parent = getParent()) != null) {
                    parent.requestDisallowInterceptTouchEvent(true);
                }
    ...
    public InputConnection onCreateInputConnection(EditorInfo outAttrs) {
        ...
        outAttrs.inputType = R.styleable.Theme_textColorLinkInverse;
    ...
    private EditText getTextFilterInput() {
        if (this.mTextFilter == null) {
            ...
            this.mTextFilter.setRawInputType(R.styleable.Theme_textColorLinkInverse);
