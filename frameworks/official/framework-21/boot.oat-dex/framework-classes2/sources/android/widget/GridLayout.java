...
public class GridLayout extends ViewGroup {
    ...
    public static final Alignment FILL = new 8();
    ...
    public void onDebugDraw(Canvas canvas) {
        ...
        paint.setColor(Color.argb(50, (int) R.styleable.Theme_actionBarTheme, (int) R.styleable.Theme_actionBarTheme, (int) R.styleable.Theme_actionBarTheme));
