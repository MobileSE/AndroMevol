...
public class StackView extends AdapterViewAnimator {
    ...
    public void transformViewForTransition(int fromIndex, int toIndex, final View view, boolean animate) {
        ...
        if (fromIndex == -1 && toIndex == getNumActiveViews() - 1) {
            ...
            StackSlider animationSlider2 = new StackSlider(this, this.mStackSlider);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        switch (ev.getAction() & R.styleable.Theme_actionBarTheme) {
            case 0:
    ...
    private void handlePointerUp(MotionEvent ev) {
        ...
        if (deltaY > this.mSwipeThreshold && this.mSwipeGestureType == 2 && this.mStackSlider.mMode == 0) {
            ...
            ObjectAnimator pa = ObjectAnimator.ofPropertyValuesHolder(new StackSlider(this, this.mStackSlider), PropertyValuesHolder.ofFloat("XProgress", 0.0f), PropertyValuesHolder.ofFloat("YProgress", finalYProgress));
            ...
            ObjectAnimator pa2 = ObjectAnimator.ofPropertyValuesHolder(new StackSlider(this, this.mStackSlider), PropertyValuesHolder.ofFloat("XProgress", 0.0f), PropertyValuesHolder.ofFloat("YProgress", finalYProgress2));
    ...
    public boolean performAccessibilityAction(int action, Bundle arguments) {
        ...
        switch (action) {
            case 4096:
                ...
                showNext();
                return true;
            case MtpConstants.RESPONSE_UNDEFINED:
                if (getDisplayedChild() <= 0) {
                    return false;
                }
                showPrevious();
