...
public class LinearLayout extends ViewGroup {
    ...
    public void measureVertical(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int delta = (heightSizeAndState & AsyncService.CMD_ASYNC_SERVICE_ON_START_INTENT) - this.mTotalLength;
    ...
    public void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int delta = (widthSizeAndState & AsyncService.CMD_ASYNC_SERVICE_ON_START_INTENT) - this.mTotalLength;
        if (skippedMeasure || (delta != 0 && totalWeight > 0.0f)) {
            if (this.mWeightSum > 0.0f) {
                weightSum = this.mWeightSum;
            } else {
