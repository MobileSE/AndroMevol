...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    final PopupPresenterCallback mPopupPresenterCallback = new PopupPresenterCallback(this, (AnonymousClass1) null);
    ...
    public boolean showOverflowMenu() {
        ...
        this.mPostedOpenRunnable = new OpenOverflowRunnable(this, new OverflowPopup(this.mContext, this.mMenu, this.mOverflowButton, true));
    ...
    public class OverflowMenuButton extends ImageButton implements ActionMenuView.ActionMenuChildView {
        ...
        public OverflowMenuButton(Context context) {
            ...
            setVisibility(0);
            setEnabled(true);
            setOnTouchListener(new 1(this, this, ActionMenuPresenter.this));
        }
