...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        int dimensionPixelOffset = a.getDimensionPixelOffset(12, 0);
        ...
        int marginEnd = a.getDimensionPixelOffset(14, -1);
        if (marginEnd >= 0) {
            this.mTitleMarginEnd = marginEnd;
        }
        int marginTop = a.getDimensionPixelOffset(15, -1);
        if (marginTop >= 0) {
            this.mTitleMarginTop = marginTop;
        }
        int marginBottom = a.getDimensionPixelOffset(16, -1);
        if (marginBottom >= 0) {
        ...
        this.mContentInsets.setAbsolute(a.getDimensionPixelSize(7, 0), a.getDimensionPixelSize(8, 0));
        ...
        if (menu != null || this.mMenuView != null) {
            ...
            if (oldMenu != menu) {
                ...
                if (this.mExpandedMenuPresenter == null) {
                    this.mExpandedMenuPresenter = new ExpandedActionViewMenuPresenter(this, (AnonymousClass1) null);
                }
