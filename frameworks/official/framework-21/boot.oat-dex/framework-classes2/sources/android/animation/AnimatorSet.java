...
public final class AnimatorSet extends Animator {
    ...
    public void start() {
        ...
        Iterator i$ = this.mNodes.iterator();
        while (i$.hasNext()) {
            i$.next().animation.setAllowRunningAsynchronously(false);
        }
        if (this.mDuration >= 0) {
            Iterator i$2 = this.mNodes.iterator();
            while (i$2.hasNext()) {
                i$2.next().animation.setDuration(this.mDuration);
            }
        }
        if (this.mInterpolator != null) {
            Iterator i$3 = this.mNodes.iterator();
            while (i$3.hasNext()) {
                i$3.next().animation.setInterpolator(this.mInterpolator);
            }
        }
        sortNodes();
        ...
        for (int i = 0; i < numSortedNodes; i++) {
            ...
            if (oldListeners != null && oldListeners.size() > 0) {
                Iterator i$4 = new ArrayList<>(oldListeners).iterator();
                while (i$4.hasNext()) {
                    Animator.AnimatorListener listener = i$4.next();
        ...
        if (this.mStartDelay <= 0) {
            Iterator i$5 = nodesToStart.iterator();
            while (i$5.hasNext()) {
                Node node3 = i$5.next();
    ...
    public boolean canReverse() {
        /*
            r8 = this;
            r2 = 0
            boolean r3 = r8.mReversible
            if (r3 != 0) goto L_0x0006
        L_0x0005:
            return r2
        L_0x0006:
            java.util.ArrayList<android.animation.AnimatorSet$Node> r3 = r8.mNodes
            java.util.Iterator r0 = r3.iterator()
        L_0x000c:
            boolean r3 = r0.hasNext()
            if (r3 == 0) goto L_0x002d
            java.lang.Object r1 = r0.next()
            android.animation.AnimatorSet$Node r1 = (android.animation.AnimatorSet.Node) r1
            android.animation.Animator r3 = r1.animation
            boolean r3 = r3.canReverse()
            if (r3 == 0) goto L_0x0005
            android.animation.Animator r3 = r1.animation
            long r4 = r3.getStartDelay()
            r6 = 0
