    ...
    public static final class Impl implements BaseColumns {
        ...
        public static String statusToString(int status) {
            switch (status) {
                ...
                case 400:
                    return "BAD_REQUEST";
                case STATUS_NOT_ACCEPTABLE /*{ENCODED_INT: 406}*/:
                    return "NOT_ACCEPTABLE";
                case STATUS_LENGTH_REQUIRED /*{ENCODED_INT: 411}*/:
                    return "LENGTH_REQUIRED";
                case STATUS_PRECONDITION_FAILED /*{ENCODED_INT: 412}*/:
                    return "PRECONDITION_FAILED";
                case 488:
                    return "FILE_ALREADY_EXISTS_ERROR";
                case STATUS_CANNOT_RESUME /*{ENCODED_INT: 489}*/:
                    return "CANNOT_RESUME";
                case STATUS_CANCELED /*{ENCODED_INT: 490}*/:
                    return "CANCELED";
                case STATUS_UNKNOWN_ERROR /*{ENCODED_INT: 491}*/:
                    return "UNKNOWN_ERROR";
                case STATUS_FILE_ERROR /*{ENCODED_INT: 492}*/:
                    return "FILE_ERROR";
                case STATUS_UNHANDLED_REDIRECT /*{ENCODED_INT: 493}*/:
                    return "UNHANDLED_REDIRECT";
                case STATUS_UNHANDLED_HTTP_CODE /*{ENCODED_INT: 494}*/:
                    return "UNHANDLED_HTTP_CODE";
                case STATUS_HTTP_DATA_ERROR /*{ENCODED_INT: 495}*/:
                    return "HTTP_DATA_ERROR";
                case STATUS_HTTP_EXCEPTION /*{ENCODED_INT: 496}*/:
                    return "HTTP_EXCEPTION";
                case STATUS_TOO_MANY_REDIRECTS /*{ENCODED_INT: 497}*/:
                    return "TOO_MANY_REDIRECTS";
                case STATUS_BLOCKED /*{ENCODED_INT: 498}*/:
                    return "BLOCKED";
                default:
