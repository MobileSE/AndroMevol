...
public final class DocumentsContract {
    ...
    public static Bitmap getDocumentThumbnail(ContentProviderClient client, Uri documentUri, Point size, CancellationSignal signal) throws RemoteException, IOException {
        ...
        try {
            ...
            opts.inSampleSize = Math.min(opts.outWidth / size.x, opts.outHeight / size.y);
            if (is != null) {
                is.reset();
    ...
    /* JADX WARNING: Removed duplicated region for block: B:6:0x0020 A[Catch:{ IOException -> 0x0059 }] */
