...
public class AndroidKeyPairGenerator extends KeyPairGeneratorSpi {
    ...
    public KeyPair generateKeyPair() {
        if (this.mKeyStore == null || this.mSpec == null) {
        ...
        } else if ((this.mSpec.getFlags() & 1) == 0 || this.mKeyStore.state() == KeyStore.State.UNLOCKED) {
            ...
            if (!this.mKeyStore.generate(privateKeyAlias, -1, keyType, this.mSpec.getKeySize(), this.mSpec.getFlags(), getArgsForKeyType(keyType, this.mSpec.getAlgorithmParameterSpec()))) {
