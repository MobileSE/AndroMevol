...
public final class SearchableInfo implements Parcelable {
    ...
    private SearchableInfo(Context activityContext, AttributeSet attr, ComponentName cName) {
        ...
        if (!(this.mSuggestAuthority == null || (pi = activityContext.getPackageManager().resolveContentProvider(this.mSuggestAuthority, 0)) == null)) {
    ...
    public static SearchableInfo getActivityMetaData(Context context, ActivityInfo activityInfo, int userId) {
        try {
            ...
            SearchableInfo activityMetaData = getActivityMetaData(userContext, xml, new ComponentName(activityInfo.packageName, activityInfo.name));
            xml.close();
