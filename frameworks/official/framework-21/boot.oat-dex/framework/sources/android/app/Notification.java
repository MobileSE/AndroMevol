...
public class Notification implements Parcelable {
    ...
    public Notification(Context context, int icon2, CharSequence tickerText2, long when2, CharSequence contentTitle, CharSequence contentText, Intent contentIntent2) {
        ...
        setLatestEventInfo(context, contentTitle, contentText, PendingIntent.getActivity(context, 0, contentIntent2, 0));
    }
    ...
    public static class Builder {
        ...
        private Builder(Context context, Notification n) {
            ...
            if (!TextUtils.isEmpty(templateClass)) {
                ...
                try {
                    style = (Style) styleClass.getConstructor(new Class[0]).newInstance(new Object[0]);
        ...
        private void shrinkLine3Text(RemoteViews contentView) {
            contentView.setTextViewTextSize(16908392, 0, (float) this.mContext.getResources().getDimensionPixelSize(17104980));
        }

        private void unshrinkLine3Text(RemoteViews contentView) {
            contentView.setTextViewTextSize(16908392, 0, (float) this.mContext.getResources().getDimensionPixelSize(17104978));
        }
        ...
        private RemoteViews applyStandardTemplate(int resId, boolean hasProgress) {
            ...
            if (this.mContentInfo != null) {
                contentView.setTextViewText(16909125, processLegacyText(this.mContentInfo));
                ...
                if (this.mNumber > this.mContext.getResources().getInteger(R.integer.status_bar_notification_info_maxnum)) {
                    contentView.setTextViewText(16909125, processLegacyText(this.mContext.getResources().getString(17039383)));
                } else {
                    contentView.setTextViewText(16909125, processLegacyText(NumberFormat.getIntegerInstance().format((long) this.mNumber)));
                }
                contentView.setViewVisibility(16909125, 0);
                showLine3 = true;
            } else {
            ...
            if (showsTimeOrChronometer()) {
                if (this.mUseChronometer) {
                    ...
                    contentView.setLong(16909121, "setBase", this.mWhen + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
            ...
            contentView.setViewPadding(16909122, 0, calculateTopPadding(this.mContext, this.mHasThreeLines, this.mContext.getResources().getConfiguration().fontScale), 0, 0);
            if (addProfileBadge(contentView, contentTextInLine2 ? 16909123 : 16909126) && !contentTextInLine2) {
                showLine3 = true;
            }
        ...
        public static int calculateTopPadding(Context ctx, boolean hasThreeLines, float fontScale) {
            int padding = ctx.getResources().getDimensionPixelSize(hasThreeLines ? 17104982 : 17104981);
            int largePadding = ctx.getResources().getDimensionPixelSize(hasThreeLines ? 17104984 : 17104983);
            float largeFactor = (MathUtils.constrain(fontScale, 1.0f, (float) LARGE_TEXT_SCALE) - 1.0f) / 0.29999995f;
        ...
        private RemoteViews applyStandardTemplateWithActions(int layoutId) {
            ...
            if (N > 0) {
                ...
                for (int i = 0; i < N; i++) {
                    big.addView(16909100, generateActionButton(this.mActions.get(i)));
                }
            }
            return big;
        }
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            button.setTextViewText(16909101, processLegacyText(action.title));
            if (!tombstone) {
        ...
        private void applyLargeIconBackground(RemoteViews contentView) {
            contentView.setInt(R.id.icon, "setBackgroundResource", 17302768);
            contentView.setDrawableParameters(R.id.icon, true, -1, resolveColor(), PorterDuff.Mode.SRC_ATOP, -1);
        ...
        private void processSmallRightIcon(int smallIconDrawableId, RemoteViews contentView) {
            if (!isLegacy() || this.mColorUtil.isGrayscaleIcon(this.mContext, smallIconDrawableId)) {
                ...
                contentView.setDrawableParameters(16908340, true, -1, resolveColor(), PorterDuff.Mode.SRC_ATOP, -1);
            }
        }
    ...
    public static abstract class Style {
        ...
        /* access modifiers changed from: protected */
        public void applyTopPadding(RemoteViews contentView) {
            contentView.setViewPadding(16909122, 0, Builder.calculateTopPadding(this.mBuilder.mContext, this.mBuilder.mHasThreeLines, this.mBuilder.mContext.getResources().getConfiguration().fontScale), 0, 0);
        }
        ...
        /* access modifiers changed from: protected */
        public void populateTickerView(Notification wip) {
        }
        ...
        /* access modifiers changed from: protected */
        public void populateHeadsUpContentView(Notification wip) {
        }
    ...
    public static class BigPictureStyle extends Style {
        ...
        private RemoteViews makeBigContentView() {
            ...
            this.mBuilder.addProfileBadge(contentView, this.mBuilder.mSubText != null && this.mBuilder.mContentText != null ? 16909123 : 16909126);
            return contentView;
        }
    ...
    public static class BigTextStyle extends Style {
        ...
        private RemoteViews makeBigContentView() {
            ...
            contentView.setInt(16909106, "setMaxLines", calculateMaxLines());
            contentView.setViewVisibility(R.id.text2, 8);
            applyTopPadding(contentView);
    ...
    public static class InboxStyle extends Style {
        ...
        private RemoteViews makeBigContentView() {
            ...
            this.mBuilder.mContentText = oldBuilderContentText;
            contentView.setViewVisibility(R.id.text2, 8);
            int[] rowIds = {16909112, 16909113, 16909114, 16909115, 16909116, 16909117, 16909118};
            ...
            float subTextSize = (float) this.mBuilder.mContext.getResources().getDimensionPixelSize(17104980);
            int i = 0;
        ...
        private RemoteViews makeMediaContentView() {
            ...
            if (N > 0) {
                ...
                for (int i = 0; i < N; i++) {
                    ...
                    view.addView(16909109, generateMediaActionButton((Action) this.mBuilder.mActions.get(this.mActionsToShowInCompact[i])));
                }
            }
            styleText(view);
            hideRightIcon(view);
        ...
        private RemoteViews makeMediaBigContentView() {
            ...
            if (actionCount > 0) {
                ...
                for (int i = 0; i < actionCount; i++) {
                    big.addView(16909109, generateMediaActionButton((Action) this.mBuilder.mActions.get(i)));
                }
            }
            styleText(big);
            hideRightIcon(big);
