...
public final class DeviceAdminInfo implements Parcelable {
    ...
    static {
        sPoliciesDisplayOrder.add(new PolicyInfo(4, "wipe-data", 17040143, 17040144));
        sPoliciesDisplayOrder.add(new PolicyInfo(2, "reset-password", 17040139, 17040140));
        sPoliciesDisplayOrder.add(new PolicyInfo(0, "limit-password", 17040135, 17040136));
        sPoliciesDisplayOrder.add(new PolicyInfo(1, "watch-login", 17040137, 17040138));
        sPoliciesDisplayOrder.add(new PolicyInfo(3, "force-lock", 17040141, 17040142));
        sPoliciesDisplayOrder.add(new PolicyInfo(5, "set-global-proxy", 17040145, 17040146));
        sPoliciesDisplayOrder.add(new PolicyInfo(6, "expire-password", 17040147, 17040148));
        sPoliciesDisplayOrder.add(new PolicyInfo(7, "encrypted-storage", 17040149, 17040150));
        sPoliciesDisplayOrder.add(new PolicyInfo(8, "disable-camera", 17040151, 17040152));
        sPoliciesDisplayOrder.add(new PolicyInfo(9, "disable-keyguard-features", 17040153, 17040154));
