...
public class ApplicationErrorReport implements Parcelable {
    ...
    public static ComponentName getErrorReportReceiver(Context context, String packageName2, int appFlags) {
        ...
        ComponentName result2 = getErrorReportReceiver(pm, packageName2, pm.getInstallerPackageName(packageName2));
        if (result2 == null) {
            return ((appFlags & 1) == 0 || (result = getErrorReportReceiver(pm, packageName2, SystemProperties.get(SYSTEM_APPS_ERROR_RECEIVER_PROPERTY))) == null) ? getErrorReportReceiver(pm, packageName2, SystemProperties.get(DEFAULT_ERROR_RECEIVER_PROPERTY)) : result;
        }
        return result2;
    }
    ...
    public static class CrashInfo {
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            if (dest.dataPosition() - start > 20480) {
