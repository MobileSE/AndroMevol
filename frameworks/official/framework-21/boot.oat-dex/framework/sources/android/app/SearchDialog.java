...
public class SearchDialog extends Dialog {
    ...
    static int resolveDialogTheme(Context context) {
        ...
        context.getTheme().resolveAttribute(16844041, outValue, true);
    ...
    private void createContentView() {
        setContentView(17367229);
        ((SearchBar) findViewById(16909176)).setSearchDialog(this);
        this.mSearchView = (SearchView) findViewById(16909178);
        ...
        this.mBadgeLabel = (TextView) this.mSearchView.findViewById(16909180);
        this.mSearchAutoComplete = (AutoCompleteTextView) this.mSearchView.findViewById(16909185);
        this.mAppIcon = (ImageView) findViewById(16909177);
        this.mSearchPlate = this.mSearchView.findViewById(16909184);
        this.mWorkingSpinner = getContext().getDrawable(17303037);
        setWorking(false);
