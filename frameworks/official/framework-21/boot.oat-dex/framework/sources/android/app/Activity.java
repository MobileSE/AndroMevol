...
public class Activity extends ContextThemeWrapper implements LayoutInflater.Factory2, Window.Callback, KeyEvent.Callback, View.OnCreateContextMenuListener, ComponentCallbacks2, Window.OnWindowDismissedCallback {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == 4) {
            ...
            if (this.mDefaultKeyMode == 2) {
                return getWindow().performPanelShortcut(0, keyCode, event, 2);
            }
    ...
    public void onApplyThemeResource(Resources.Theme theme, int resid, boolean first) {
        ...
        if (theme != null) {
            ...
            int colorPrimary = a.getColor(257, 0);
            a.recycle();
            if (colorPrimary != 0) {
                setTaskDescription(new ActivityManager.TaskDescription((String) null, (Bitmap) null, colorPrimary));
            }
        }
    }
    ...
    public String getLocalClassName() {
        ...
        return (!cls.startsWith(pkg) || cls.length() <= packageLen || cls.charAt(packageLen) != '.') ? cls : cls.substring(packageLen + 1);
    }
    ...
    public void setTaskDescription(ActivityManager.TaskDescription taskDescription) {
        ...
        if (taskDescription.getIconFilename() != null || taskDescription.getIcon() == null) {
            ...
            td = new ActivityManager.TaskDescription(taskDescription.getLabel(), Bitmap.createScaledBitmap(taskDescription.getIcon(), size, size, true), taskDescription.getPrimaryColor());
        }
        try {
    ...
    public Intent getParentActivityIntent() {
        ...
        if (!TextUtils.isEmpty(parentName)) {
            ...
            try {
                parentIntent = getPackageManager().getActivityInfo(target, 0).parentActivityName == null ? Intent.makeMainActivity(target) : new Intent().setComponent(target);
    ...
    /* access modifiers changed from: package-private */
    public final void performCreateCommon() {
        boolean z = false;
