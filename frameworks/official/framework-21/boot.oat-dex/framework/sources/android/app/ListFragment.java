    ...
    private void ensureList() {
        if (this.mList == null) {
            ...
            if (root instanceof ListView) {
                ...
                this.mStandardEmptyView = (TextView) root.findViewById(16909082);
                if (this.mStandardEmptyView == null) {
                    this.mEmptyView = root.findViewById(R.id.empty);
                } else {
                    this.mStandardEmptyView.setVisibility(8);
                }
                this.mProgressContainer = root.findViewById(16909080);
                this.mListContainer = root.findViewById(16909081);
