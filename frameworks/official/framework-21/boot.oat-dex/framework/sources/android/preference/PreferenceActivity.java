...
public abstract class PreferenceActivity extends ListActivity implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceFragment.OnPreferenceStartFragmentCallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TypedArray sa = obtainStyledAttributes(null, com.android.internal.R.styleable.PreferenceActivity, 16843813, 0);
        int layoutResId = sa.getResourceId(0, 17367195);
        this.mPreferenceHeaderItemResId = sa.getResourceId(1, 17367189);
        this.mPreferenceHeaderRemoveEmptyIcon = sa.getBoolean(2, false);
        sa.recycle();
        setContentView(layoutResId);
        this.mListFooter = (FrameLayout) findViewById(16909140);
        this.mPrefsContainer = (ViewGroup) findViewById(16909141);
        ...
        if (initialFragment != null && this.mSinglePane) {
            findViewById(16909139).setVisibility(8);
            ...
            this.mListFooter = (FrameLayout) findViewById(16909140);
            this.mPrefsContainer = (ViewGroup) findViewById(16909142);
            this.mPreferenceManager = new PreferenceManager(this, 100);
            this.mPreferenceManager.setOnPreferenceTreeClickListener(this);
        }
        Intent intent = getIntent();
        if (intent.getBooleanExtra(EXTRA_PREFS_SHOW_BUTTON_BAR, false)) {
            findViewById(16909010).setVisibility(0);
            Button backButton = (Button) findViewById(16909143);
            ...
            Button skipButton = (Button) findViewById(16909144);
            ...
            this.mNextButton = (Button) findViewById(16909145);
    ...
    public boolean onIsMultiPane() {
        return getResources().getBoolean(17956871);
    }
            ...
            try {
                ...
                if (this.mFragmentBreadCrumbs != null) {
                    if (this.mSinglePane) {
                        ...
                        View bcSection = findViewById(16909019);
                        if (bcSection != null) {
    ...
    private void switchToHeaderInner(String fragmentName, Bundle args) {
        ...
        transaction.replace(16909142, f);
    ...
    public void startPreferenceFragment(Fragment fragment, boolean push) {
        FragmentTransaction transaction = getFragmentManager().beginTransaction();
        transaction.replace(16909142, fragment);
        if (push) {
