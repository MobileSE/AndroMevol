...
public class PreferenceFrameLayout extends FrameLayout {
    ...
    public PreferenceFrameLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mBorderBottom = a.getDimensionPixelSize(1, (int) ((density * 0.0f) + 0.5f));
        this.mBorderLeft = a.getDimensionPixelSize(2, (int) ((density * 0.0f) + 0.5f));
        this.mBorderRight = a.getDimensionPixelSize(3, (int) ((density * 0.0f) + 0.5f));
        a.recycle();
    }
