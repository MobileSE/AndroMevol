...
public class UserManager {
    ...
    public static boolean supportsMultipleUsers() {
        return getMaxSupportedUsers() > 1 && SystemProperties.getBoolean("fw.show_multiuserui", Resources.getSystem().getBoolean(17956957));
    }
    ...
    public boolean isUserSwitcherEnabled() {
        ...
        return switchableUserCount > 1 || (Settings.Global.getInt(this.mContext.getContentResolver(), Settings.Global.GUEST_USER_ENABLED, 0) == 1);
    }
