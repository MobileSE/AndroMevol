...
public abstract class BatteryStats implements Parcelable {
    ...
    static final String[] DATA_CONNECTION_NAMES = {Camera.Parameters.EFFECT_NONE, "gprs", "edge", "umts", "cdma", "evdo_0", "evdo_A", "1xrtt", "hsdpa", "hsupa", "hspa", "iden", "evdo_b", "lte", "ehrpd", "hspap", CardEmulation.CATEGORY_OTHER};
    ...
    public static final String[] HISTORY_EVENT_NAMES = {"null", "proc", FOREGROUND_DATA, "top", "sync", "wake_lock_in", "job", Context.USER_SERVICE, "userfg"};
        ...
        public void printNextItem(PrintWriter pw, HistoryItem rec, long baseTime, boolean checkin, boolean verbose) {
            ...
            if (rec.cmd == 4) {
                ...
                if (this.oldPlug != rec.batteryPlugType) {
                    ...
                    switch (this.oldPlug) {
                        case 0:
                            pw.print(checkin ? "n" : Camera.Parameters.EFFECT_NONE);
                            break;
                        case 1:
