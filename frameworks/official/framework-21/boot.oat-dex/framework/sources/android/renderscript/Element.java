...
public class Element extends BaseObj {
    ...
    /* JADX INFO: Multiple debug info for r2v1 android.renderscript.Element$DataKind[]: [D('arr$' android.renderscript.Element$DataType[]), D('arr$' android.renderscript.Element$DataKind[])] */
