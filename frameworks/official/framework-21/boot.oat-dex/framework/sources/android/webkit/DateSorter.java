...
public class DateSorter {
    ...
    public DateSorter(Context context) {
        ...
        this.mLabels[2] = String.format(resources.getQuantityString(18087940, 7), 7);
        this.mLabels[3] = context.getString(17040441);
        this.mLabels[4] = context.getString(17040442);
    }
