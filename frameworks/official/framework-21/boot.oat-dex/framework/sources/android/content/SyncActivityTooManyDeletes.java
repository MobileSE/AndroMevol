...
public class SyncActivityTooManyDeletes extends Activity implements AdapterView.OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ListAdapter adapter = new ArrayAdapter(this, (int) R.layout.simple_list_item_1, (int) R.id.text1, new CharSequence[]{getResources().getText(17040741), getResources().getText(17040742), getResources().getText(17040743)});
        ListView listView = new ListView(this);
        listView.setAdapter(adapter);
        listView.setItemsCanFocus(true);
        listView.setOnItemClickListener(this);
        TextView textView = new TextView(this);
        textView.setText(String.format(getResources().getText(17040740).toString(), Long.valueOf(this.mNumDeletes), this.mProvider, this.mAccount.name));
