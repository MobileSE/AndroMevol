...
public class ContentProviderClient {
    ...
    public boolean release() {
        boolean releaseUnstableProvider;
        synchronized (this) {
            if (this.mReleased) {
            ...
            this.mGuard.close();
            if (this.mStable) {
                releaseUnstableProvider = this.mContentResolver.releaseProvider(this.mContentProvider);
            } else {
                releaseUnstableProvider = this.mContentResolver.releaseUnstableProvider(this.mContentProvider);
            }
        }
        return releaseUnstableProvider;
    }
