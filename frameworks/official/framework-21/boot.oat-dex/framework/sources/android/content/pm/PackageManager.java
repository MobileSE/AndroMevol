...
public abstract class PackageManager {
    ...
    public PackageInfo getPackageArchiveInfo(String archiveFilePath, int flags) {
        ...
        try {
            PackageParser.Package pkg = parser.parseMonolithicPackage(new File(archiveFilePath), 0);
            if ((flags & 64) != 0) {
    ...
    public static String installStatusToString(int status) {
        switch (status) {
            case INSTALL_FAILED_ABORTED /*{ENCODED_INT: -115}*/:
                return "INSTALL_FAILED_ABORTED";
            case INSTALL_FAILED_NO_MATCHING_ABIS /*{ENCODED_INT: -113}*/:
            ...
            case INSTALL_PARSE_FAILED_BAD_MANIFEST /*{ENCODED_INT: -101}*/:
                return "INSTALL_PARSE_FAILED_BAD_MANIFEST";
            case -100:
                return "INSTALL_PARSE_FAILED_NOT_APK";
            case INSTALL_FAILED_VERSION_DOWNGRADE /*{ENCODED_INT: -25}*/:
                return "INSTALL_FAILED_VERSION_DOWNGRADE";
            case INSTALL_FAILED_UID_CHANGED /*{ENCODED_INT: -24}*/:
                return "INSTALL_FAILED_UID_CHANGED";
            case INSTALL_FAILED_PACKAGE_CHANGED /*{ENCODED_INT: -23}*/:
