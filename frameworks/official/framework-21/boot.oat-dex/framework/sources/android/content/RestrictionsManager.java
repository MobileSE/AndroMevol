    ...
    private List<RestrictionEntry> loadManifestRestrictions(String packageName, XmlResourceParser xml) {
        ...
        try {
            ...
            try {
                ...
                while (tagType != 1) {
                    if (tagType == 2 && xml.getName().equals(TAG_RESTRICTION) && (attrSet = Xml.asAttributeSet(xml)) != null && (restriction = loadRestriction(appContext, appContext.obtainStyledAttributes(attrSet, R.styleable.RestrictionEntry))) != null) {
