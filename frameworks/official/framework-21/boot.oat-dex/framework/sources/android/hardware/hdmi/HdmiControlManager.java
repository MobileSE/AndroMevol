...
public final class HdmiControlManager {
    ...
    public static final String EXTRA_MESSAGE_EXTRAM_PARAM1 = "android.hardware.hdmi.extra.MESSAGE_EXTRA_PARAM1";
    ...
    public interface VendorCommandListener {
        void onReceived(int i, byte[] bArr, boolean z);
    }
    ...
    public void addHotplugEventListener(HotplugEventListener listener) {
        if (this.mService != null) {
            try {
                this.mService.addHotplugEventListener(getHotplugEventListenerWrapper(listener));
            } catch (RemoteException e) {
            }
        }
    }
    ...
    public void removeHotplugEventListener(HotplugEventListener listener) {
        if (this.mService != null) {
            try {
                this.mService.removeHotplugEventListener(getHotplugEventListenerWrapper(listener));
            } catch (RemoteException e) {
            }
        }
    }
