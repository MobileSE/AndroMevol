...
public class KeyphraseEnrollmentInfo {
    ...
    public KeyphraseEnrollmentInfo(PackageManager pm) {
        ...
        while (true) {
            ...
            try {
                ai = pm.getApplicationInfo(i$.next().activityInfo.packageName, 128);
        ...
        try {
            XmlResourceParser parser2 = ai.loadXmlMetaData(pm, VOICE_KEYPHRASE_META_DATA);
            if (parser2 == null) {
            ...
            if (!"voice-enrollment-application".equals(parser2.getName())) {
    ...
    private void initializeKeyphrasesFromTypedArray(TypedArray array) {
        ...
        if (!TextUtils.isEmpty(searchKeyphraseSupportedLocales)) {
            try {
                for (String str : searchKeyphraseSupportedLocales.split(",")) {
