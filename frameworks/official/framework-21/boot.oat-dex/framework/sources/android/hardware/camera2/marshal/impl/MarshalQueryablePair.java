...
public class MarshalQueryablePair<T1, T2> implements MarshalQueryable<Pair<T1, T2>> {
    ...
    private class MarshalerPair extends Marshaler<Pair<T1, T2>> {
        ...
        /* JADX DEBUG: Type inference failed for r4v10. Raw type applied. Possible types: java.lang.reflect.Constructor<? super android.util.Pair<T1, T2>>, java.lang.reflect.Constructor<android.util.Pair<T1, T2>> */
