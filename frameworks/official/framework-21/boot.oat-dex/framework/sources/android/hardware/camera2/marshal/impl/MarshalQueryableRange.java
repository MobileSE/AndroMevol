...
public class MarshalQueryableRange<T extends Comparable<? super T>> implements MarshalQueryable<Range<T>> {
    ...
    private class MarshalerRange extends Marshaler<Range<T>> {
        ...
        /* JADX DEBUG: Type inference failed for r4v7. Raw type applied. Possible types: java.lang.reflect.Constructor<? super android.util.Range<T>>, java.lang.reflect.Constructor<android.util.Range<T>> */
