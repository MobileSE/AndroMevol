...
public class SurfaceTextureRenderer {
    ...
    private void configureEGLContext() {
        ...
        EGL14.eglChooseConfig(this.mEGLDisplay, new int[]{EGL14.EGL_RED_SIZE, 8, EGL14.EGL_GREEN_SIZE, 8, EGL14.EGL_BLUE_SIZE, 8, EGL14.EGL_RENDERABLE_TYPE, 4, EGL_RECORDABLE_ANDROID, 1, EGL14.EGL_SURFACE_TYPE, 5, EGL14.EGL_NONE}, 0, configs, 0, configs.length, new int[1], 0);
