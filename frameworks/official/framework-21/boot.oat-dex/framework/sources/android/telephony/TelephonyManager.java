...
public class TelephonyManager {
    ...
    private static final String sLteOnCdmaProductType = SystemProperties.get("telephony.lteOnCdmaProductType", ProxyInfo.LOCAL_EXCL_LIST);
    ...
    private int getPhoneTypeFromProperty(long subId) {
        String type = getTelephonyProperty("gsm.current.phone-type", subId, null);
        if (type != null) {
    ...
    public String getNetworkOperatorName(long subId) {
        return getTelephonyProperty("gsm.operator.alpha", subId, ProxyInfo.LOCAL_EXCL_LIST);
    }
    ...
    public String getNetworkOperator(long subId) {
        return getTelephonyProperty("gsm.operator.numeric", subId, ProxyInfo.LOCAL_EXCL_LIST);
    }
    ...
    public boolean isNetworkRoaming(long subId) {
        return "true".equals(getTelephonyProperty("gsm.operator.isroaming", subId, null));
    }
    ...
    public String getNetworkCountryIso(long subId) {
        return getTelephonyProperty("gsm.operator.iso-country", subId, ProxyInfo.LOCAL_EXCL_LIST);
    }
    ...
    public int getSimState(int slotId) {
        ...
        String prop = getTelephonyProperty("gsm.sim.state", subId[0], ProxyInfo.LOCAL_EXCL_LIST);
    ...
    public String getSimOperator(long subId) {
        String operator = getTelephonyProperty("gsm.sim.operator.numeric", subId, ProxyInfo.LOCAL_EXCL_LIST);
    ...
    public String getSimOperatorName(long subId) {
        return getTelephonyProperty("gsm.sim.operator.alpha", subId, ProxyInfo.LOCAL_EXCL_LIST);
    }
    ...
    public String getSimCountryIso(long subId) {
        return getTelephonyProperty("gsm.sim.operator.iso-country", subId, ProxyInfo.LOCAL_EXCL_LIST);
    }
