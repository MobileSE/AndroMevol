...
public class PhoneNumberUtils {
    ...
    public static boolean compare(Context context, String a, String b) {
        return compare(a, b, context.getResources().getBoolean(17956909));
    }
    ...
    public static String cdmaCheckAndProcessPlusCode(String dialStr) {
        ...
        String currIso = SystemProperties.get("gsm.operator.iso-country", ProxyInfo.LOCAL_EXCL_LIST);
        String defaultIso = SystemProperties.get("gsm.sim.operator.iso-country", ProxyInfo.LOCAL_EXCL_LIST);
