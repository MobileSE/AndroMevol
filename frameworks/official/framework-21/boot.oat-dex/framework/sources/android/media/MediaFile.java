...
public class MediaFile {
    ...
    static {
        addFileType("MP3", 1, MediaFormat.MIMETYPE_AUDIO_MPEG, EGL14.EGL_BAD_MATCH);
        addFileType("MPGA", 1, MediaFormat.MIMETYPE_AUDIO_MPEG, EGL14.EGL_BAD_MATCH);
        addFileType("M4A", 2, "audio/mp4", EGL14.EGL_BAD_NATIVE_WINDOW);
        addFileType("WAV", 3, "audio/x-wav", EGL14.EGL_BAD_DISPLAY);
        ...
        addFileType("MPEG", 21, "video/mpeg", EGL14.EGL_BAD_NATIVE_WINDOW);
        addFileType("MPG", 21, "video/mpeg", EGL14.EGL_BAD_NATIVE_WINDOW);
        addFileType("MP4", 21, "video/mp4", EGL14.EGL_BAD_NATIVE_WINDOW);
        addFileType("M4V", 22, "video/mp4", EGL14.EGL_BAD_NATIVE_WINDOW);
        addFileType("3GP", 23, MediaFormat.MIMETYPE_VIDEO_H263, 47492);
        addFileType("3GPP", 23, MediaFormat.MIMETYPE_VIDEO_H263, 47492);
        ...
        addFileType("FLAC", 10, MediaFormat.MIMETYPE_AUDIO_FLAC, 47366);
    ...
    public static int getFormatCode(String fileName, String mimeType) {
        ...
        if (lastDot <= 0 || (value = sFileTypeToFormatMap.get(fileName.substring(lastDot + 1).toUpperCase(Locale.ROOT))) == null) {
            return 12288;
        }
        return value.intValue();
    }
