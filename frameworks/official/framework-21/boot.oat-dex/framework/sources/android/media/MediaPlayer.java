...
public class MediaPlayer implements SubtitleController.Listener {
    ...
    public void setDataSource(Context context, Uri uri, Map<String, String> headers) throws IOException, IllegalArgumentException, SecurityException, IllegalStateException {
        ...
        try {
            AssetFileDescriptor fd2 = context.getContentResolver().openAssetFileDescriptor(uri, FullBackup.ROOT_TREE_TOKEN);
            if (fd2 != null) {
    ...
    public TrackInfo[] getTrackInfo() throws IllegalStateException {
        ...
        while (i$.hasNext()) {
            ...
            allTrackInfo[i] = new TrackInfo(track.isTimedText() ? 3 : 4, track.getFormat());
            i++;
        }
        return allTrackInfo;
    }
            ...
            new Handler(thread.getLooper()).post(new Runnable() {
                ...
                private int addTrack() {
                    ...
                    try {
                        ...
                        long total = 0;
                        while (total < length && (bytes = IoBridge.read(fd2, buffer, 0, (int) Math.min((long) buffer.length, length - total))) >= 0) {
                ...
                case 200:
                    switch (msg.arg1) {
                        case 700:
                            ...
                            break;
                        case MediaPlayer.MEDIA_INFO_METADATA_UPDATE /*{ENCODED_INT: 802}*/:
                            MediaPlayer.this.scanInternalSubtitleTracks();
                        case MediaPlayer.MEDIA_INFO_EXTERNAL_METADATA_UPDATE /*{ENCODED_INT: 803}*/:
                    ...
                    if (refreshTime || nanoTime >= this.mLastNanoTime + MAX_NS_WITHOUT_POSITION_CHECK) {
                        try {
                            ...
                            if (this.DEBUG) {
                                ...
                                Log.v(TAG, sb.append(str).append(" at ").append(this.mLastTimeUs).toString());
                            }
