...
public interface ITrustAgentService extends IInterface {
    ...
    void setTrustAgentFeaturesEnabled(Bundle bundle, IBinder iBinder) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements ITrustAgentService {
        ...
        static final int TRANSACTION_setTrustAgentFeaturesEnabled = 4;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    setTrustAgentFeaturesEnabled(_arg0, data.readStrongBinder());
                    return true;
        ...
        private static class Proxy implements ITrustAgentService {
            ...
            @Override // android.service.trust.ITrustAgentService
            public void setTrustAgentFeaturesEnabled(Bundle options, IBinder token) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (options != null) {
