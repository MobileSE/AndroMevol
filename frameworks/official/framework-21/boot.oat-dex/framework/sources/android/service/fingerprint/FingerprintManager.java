...
public class FingerprintManager {
    ...
    private Handler mHandler = new Handler() {
        /* class android.service.fingerprint.FingerprintManager.AnonymousClass1 */
    ...
    private IFingerprintServiceReceiver mServiceReceiver = new IFingerprintServiceReceiver.Stub() {
        /* class android.service.fingerprint.FingerprintManager.AnonymousClass2 */
    ...
    public boolean enrolledAndEnabled() {
        ...
        if (Settings.Secure.getInt(res, "fingerprint_enabled", 0) == 0 || FingerprintUtils.getFingerprintIdsForUser(res, getCurrentUserId()).length <= 0) {
            return false;
        }
        return true;
    }
