...
public abstract class VoiceInteractionSession implements KeyEvent.Callback {
    ...
    public void initViews() {
        ...
        this.mRootView = this.mInflater.inflate(17367272, (ViewGroup) null);
    ...
    public void onCreate(Bundle args) {
        ...
        this.mWindow = new SoftInputWindow(this.mContext, TAG, this.mTheme, this.mCallbacks, this, this.mDispatcherState, (int) WindowManager.LayoutParams.TYPE_VOICE_INTERACTION, 48, true);
