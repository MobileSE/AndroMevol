...
public class ZenModeConfig implements Parcelable {
    ...
    public static Condition toTimeCondition(long time, int minutes) {
        ...
        return new Condition(toCountdownConditionId(time), Resources.getSystem().getQuantityString(minutes < 60 ? 18087961 : 18087962, num, Integer.valueOf(num)), ProxyInfo.LOCAL_EXCL_LIST, ProxyInfo.LOCAL_EXCL_LIST, 0, 1, 1);
    }
