...
public class View implements Drawable.Callback, KeyEvent.Callback, AccessibilityEventSource {
    ...
    public boolean draw(Canvas canvas, ViewGroup parent, long drawingTime) {
        ...
        this.mPrivateFlags |= 32;
        if (concatMatrix2 || (flags & GLES10.GL_EXP2) != 1 || !canvas.quickReject((float) this.mLeft, (float) this.mTop, (float) this.mRight, (float) this.mBottom, Canvas.EdgeType.BW) || (this.mPrivateFlags & 64) != 0) {
    ...
    /* JADX INFO: Multiple debug info for r6v2 java.util.Iterator<java.lang.String>: [D('i$' java.util.Iterator), D('i$' int)] */
