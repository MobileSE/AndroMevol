...
public final class TextServicesManager {
    ...
    public SpellCheckerSession newSpellCheckerSession(Bundle bundle, Locale locale, SpellCheckerSession.SpellCheckerSessionListener listener, boolean referToSpellCheckerLanguageSettings) {
        if (listener == null) {
            ...
            try {
                SpellCheckerInfo sci = sService.getCurrentSpellChecker((String) null);
                if (sci == null) {
                    return null;
                }
    ...
    public void setCurrentSpellChecker(SpellCheckerInfo sci) {
        if (sci == null) {
            ...
            sService.setCurrentSpellChecker((String) null, sci.getId());
        }
    }
    ...
    public SpellCheckerSubtype getCurrentSpellCheckerSubtype(boolean allowImplicitlySelectedSubtype) {
        try {
            if (sService != null) {
                return sService.getCurrentSpellCheckerSubtype((String) null, allowImplicitlySelectedSubtype);
            }
    ...
    public void setSpellCheckerSubtype(SpellCheckerSubtype subtype) {
        ...
        try {
            sService.setCurrentSpellCheckerSubtype((String) null, hashCode);
        } catch (RemoteException e) {
