        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 6:
                    ...
                    int _result5 = relayout(_arg05, _arg18, _arg22, _arg36, _arg46, _arg55, _arg63, _arg7, _arg8, _arg9, _arg10, _arg11, _arg122, _arg132);
                    reply.writeNoException();
                ...
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    performDeferredDestroy(IWindow.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result6 = outOfMemory(IWindow.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                ...
                case 9:
                    ...
                    setTransparentRegion(_arg06, _arg13);
                    reply.writeNoException();
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setInsets(_arg07, _arg19, _arg2, _arg3, _arg4);
                    reply.writeNoException();
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    getDisplayFrame(_arg08, _arg110);
                    reply.writeNoException();
                    if (_arg110 != null) {
                        reply.writeInt(1);
                ...
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result8 = performHapticFeedback(IWindow.Stub.asInterface(data.readStrongBinder()), data.readInt(), data.readInt() != 0);
                    reply.writeNoException();
                ...
                case 16:
                    ...
                    IBinder _result9 = prepareDrag(_arg09, _arg111, _arg27, _arg37, _arg47);
                    reply.writeNoException();
                ...
                case 17:
                    ...
                    boolean _result10 = performDrag(_arg010, _arg112, _arg28, _arg38, _arg48, _arg56, _arg6);
                    reply.writeNoException();
                    reply.writeInt(_result10 ? 1 : 0);
                    return true;
                case 18:
                    data.enforceInterface(DESCRIPTOR);
                    reportDropResult(IWindow.Stub.asInterface(data.readStrongBinder()), data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 19:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 24:
                    ...
                    Bundle _result11 = sendWallpaperCommand(_arg011, _arg113, _arg29, _arg39, _arg49, _arg5, data.readInt() != 0);
                    reply.writeNoException();
                    if (_result11 != null) {
                        reply.writeInt(1);
                ...
                case 25:
                    ...
                    wallpaperCommandComplete(_arg012, _arg12);
                    reply.writeNoException();
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 27:
                    ...
                    onRectangleOnScreenRequested(_arg013, _arg1);
                    reply.writeNoException();
                    return true;
                case 28:
                    data.enforceInterface(DESCRIPTOR);
                    IWindowId _result12 = getWindowId(data.readStrongBinder());
                    reply.writeNoException();
