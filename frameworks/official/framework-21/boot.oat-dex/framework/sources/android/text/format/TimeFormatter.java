    ...
    public TimeFormatter() {
        synchronized (TimeFormatter.class) {
            ...
            if (sLocale == null || !locale.equals(sLocale)) {
                ...
                sTimeOnlyFormat = r.getString(17039445);
                sDateOnlyFormat = r.getString(17039444);
                sDateTimeFormat = r.getString(17039446);
            }
        ...
        while (formatBuffer.remaining() > 1) {
            ...
            switch (currentChar) {
                ...
                case 72:
                    ...
                    return false;
                case 73:
                    this.numberFormatter.format(getFormat(modifier, "%02d", "%2d", "%d", "%02d"), Integer.valueOf(wallTime.getHour() % 12 != 0 ? wallTime.getHour() % 12 : 12));
                    return false;
                case 77:
                ...
                case 85:
                    ...
                    return false;
                case 87:
                    this.numberFormatter.format(getFormat(modifier, "%02d", "%2d", "%d", "%02d"), Integer.valueOf(((wallTime.getYearDay() + 7) - (wallTime.getWeekDay() != 0 ? wallTime.getWeekDay() - 1 : 6)) / 7));
                    return false;
                case 88:
                ...
                case 107:
                    ...
                    return false;
                case 108:
                    this.numberFormatter.format(getFormat(modifier, "%2d", "%2d", "%d", "%02d"), Integer.valueOf(wallTime.getHour() % 12 != 0 ? wallTime.getHour() % 12 : 12));
                    return false;
                case 109:
