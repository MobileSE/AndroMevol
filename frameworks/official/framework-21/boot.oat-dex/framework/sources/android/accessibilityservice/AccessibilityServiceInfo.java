...
public class AccessibilityServiceInfo implements Parcelable {
    ...
    static {
        sAvailableCapabilityInfos.put(1, new CapabilityInfo(1, 17039685, 17039686));
        sAvailableCapabilityInfos.put(2, new CapabilityInfo(2, 17039687, 17039688));
        sAvailableCapabilityInfos.put(4, new CapabilityInfo(4, 17039689, 17039690));
        sAvailableCapabilityInfos.put(8, new CapabilityInfo(8, 17039691, 17039692));
    }
