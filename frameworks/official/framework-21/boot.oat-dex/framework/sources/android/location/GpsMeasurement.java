...
public class GpsMeasurement implements Parcelable {
    ...
    public String toString() {
        ...
        if (hasCodePhaseInChips()) {
            d = Double.valueOf(this.mCodePhaseInChips);
        } else {
            d = null;
        }
        objArr2[1] = d;
        ...
        if (hasCarrierFrequencyInHz()) {
            f = Float.valueOf(this.mCarrierFrequencyInHz);
        } else {
            f = null;
        }
        objArr3[1] = f;
        ...
        if (hasCarrierCycles()) {
            l = Long.valueOf(this.mCarrierCycles);
        } else {
            l = null;
        }
        objArr4[1] = l;
        ...
        if (hasCarrierPhase()) {
            d2 = Double.valueOf(this.mCarrierPhase);
        } else {
            d2 = null;
        }
        objArr5[1] = d2;
        ...
        objArr6[0] = "BitNumber";
        if (hasBitNumber()) {
            num = Integer.valueOf(this.mBitNumber);
        } else {
            num = null;
        }
        objArr6[1] = num;
        ...
        if (hasTimeFromLastBitInMs()) {
            sh = Short.valueOf(this.mTimeFromLastBitInMs);
        } else {
            sh = null;
        }
        objArr7[1] = sh;
        ...
        if (hasDopplerShiftInHz()) {
            d3 = Double.valueOf(this.mDopplerShiftInHz);
        } else {
            d3 = null;
        }
        objArr8[1] = d3;
        ...
        objArr9[0] = "SnrInDb";
        if (hasSnrInDb()) {
            d4 = Double.valueOf(this.mSnrInDb);
        } else {
            d4 = null;
        }
        objArr9[1] = d4;
        ...
        if (hasElevationInDeg()) {
            d5 = Double.valueOf(this.mElevationInDeg);
        } else {
            d5 = null;
        }
        objArr10[1] = d5;
        ...
        if (hasAzimuthInDeg()) {
            d6 = Double.valueOf(this.mAzimuthInDeg);
        } else {
            d6 = null;
        }
        objArr11[1] = d6;
        ...
        if (hasAzimuthUncertaintyInDeg()) {
            d7 = Double.valueOf(this.mAzimuthUncertaintyInDeg);
        }
        objArr11[3] = d7;
        builder.append(String.format("   %-29s = %-25s   %-40s = %s\n", objArr11));
