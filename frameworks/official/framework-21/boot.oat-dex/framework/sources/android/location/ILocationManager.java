...
public interface ILocationManager extends IInterface {
    ...
    boolean removeGpsMeasurementsListener(IGpsMeasurementsListener iGpsMeasurementsListener) throws RemoteException;

    boolean removeGpsNavigationMessageListener(IGpsNavigationMessageListener iGpsNavigationMessageListener) throws RemoteException;
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    requestLocationUpdates(_arg07, _arg17, _arg24, data.readString());
                ...
                case 2:
                    ...
                    removeUpdates(_arg08, _arg16, data.readString());
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    requestGeofence(_arg06, _arg15, _arg23, data.readString());
                    reply.writeNoException();
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    removeGeofence(_arg05, _arg14, data.readString());
                    reply.writeNoException();
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result2 = addGpsStatusListener(IGpsStatusListener.Stub.asInterface(data.readStrongBinder()), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result2 ? 1 : 0);
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    removeGpsStatusListener(IGpsStatusListener.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 9:
                    ...
                    String _result4 = getFromLocation(_arg09, _arg18, _arg25, _arg3, arrayList);
                    reply.writeNoException();
                ...
                case 10:
                    ...
                    String _result5 = getFromLocationName(_arg010, _arg19, _arg26, _arg32, _arg4, _arg5, _arg6, arrayList2);
                    reply.writeNoException();
                ...
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result6 = sendNiResponse(data.readInt(), data.readInt());
                    reply.writeNoException();
                    reply.writeInt(_result6 ? 1 : 0);
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result7 = addGpsMeasurementsListener(IGpsMeasurementsListener.Stub.asInterface(data.readStrongBinder()), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result7 ? 1 : 0);
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result8 = removeGpsMeasurementsListener(IGpsMeasurementsListener.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    reply.writeInt(_result8 ? 1 : 0);
                    return true;
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result9 = addGpsNavigationMessageListener(IGpsNavigationMessageListener.Stub.asInterface(data.readStrongBinder()), data.readString());
                    reply.writeNoException();
                    reply.writeInt(_result9 ? 1 : 0);
                    return true;
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result10 = removeGpsNavigationMessageListener(IGpsNavigationMessageListener.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                    reply.writeInt(_result10 ? 1 : 0);
                    return true;
                case 16:
                    data.enforceInterface(DESCRIPTOR);
                    List<String> _result11 = getAllProviders();
                    reply.writeNoException();
                ...
                case 17:
                    ...
                    List<String> _result12 = getProviders(_arg03, data.readInt() != 0);
                    reply.writeNoException();
                ...
                case 18:
                    ...
                    String _result13 = getBestProvider(_arg02, data.readInt() != 0);
                    reply.writeNoException();
                ...
                case 19:
                    ...
                    boolean _result14 = providerMeetsCriteria(_arg011, _arg13);
                    reply.writeNoException();
                    reply.writeInt(_result14 ? 1 : 0);
                    return true;
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                    ProviderProperties _result15 = getProviderProperties(data.readString());
                    reply.writeNoException();
                    if (_result15 != null) {
                        reply.writeInt(1);
                ...
                case 21:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _result16 = isProviderEnabled(data.readString());
                    reply.writeNoException();
                ...
                case 22:
                    ...
                    if (data.readInt() != 0) {
                        _arg12 = (ProviderProperties) ProviderProperties.CREATOR.createFromParcel(data);
                    } else {
                        _arg12 = null;
                    }
                    addTestProvider(_arg012, _arg12);
                    reply.writeNoException();
                    return true;
                case 23:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 24:
                    ...
                    setTestProviderLocation(_arg013, _arg1);
                    reply.writeNoException();
                    return true;
                case 25:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 28:
                    ...
                    setTestProviderStatus(_arg014, _arg110, _arg22, data.readLong());
                    reply.writeNoException();
                    return true;
                case 29:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 30:
                    ...
                    boolean _result17 = sendExtraCommand(_arg015, _arg111, _arg2);
                    reply.writeNoException();
                ...
                case 31:
                    ...
                    reportLocation(_arg0, data.readInt() != 0);
                    reply.writeNoException();
                    return true;
                case 32:
                    data.enforceInterface(DESCRIPTOR);
