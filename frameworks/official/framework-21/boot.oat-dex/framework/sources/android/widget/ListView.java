...
public class ListView extends AbsListView {
    ...
    public ListView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mArrowScrollFocusResult = new ArrowScrollFocusResult((AnonymousClass1) null);
        ...
        if (entries != null) {
            setAdapter((ListAdapter) new ArrayAdapter(context, (int) android.R.layout.simple_list_item_1, entries));
        }
    ...
    public void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (getChildCount() > 0 && (focusedChild = getFocusedChild()) != null) {
            ...
            if (this.mFocusSelector == null) {
                this.mFocusSelector = new FocusSelector(this, (AnonymousClass1) null);
            }
