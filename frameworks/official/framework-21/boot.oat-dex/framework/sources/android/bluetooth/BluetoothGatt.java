...
public final class BluetoothGatt implements BluetoothProfile {
    ...
    private final IBluetoothGattCallback mBluetoothGattCallback = new BluetoothGattCallbackWrapper() {
        ...
        public void onClientRegistered(int status, int clientIf) {
            ...
            try {
                ...
                iBluetoothGatt.clientConnect(i, address, z, BluetoothGatt.this.mTransport);
    ...
    public BluetoothGattService getService(BluetoothDevice device, UUID uuid, int instanceId, int type) {
    ...
    public boolean writeCharacteristic(BluetoothGattCharacteristic characteristic) {
        ...
        if (((characteristic.getProperties() & 8) == 0 && (characteristic.getProperties() & 4) == 0) || this.mService == null || this.mClientIf == 0 || (service = characteristic.getService()) == null || (device = service.getDevice()) == null) {
            return false;
        }
        synchronized (this.mDeviceBusy) {
            if (this.mDeviceBusy.booleanValue()) {
