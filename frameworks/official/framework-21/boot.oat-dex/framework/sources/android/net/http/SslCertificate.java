...
public class SslCertificate {
    ...
    public View inflateCertificateView(Context context) {
        View certificateView = LayoutInflater.from(context).inflate(17367246, (ViewGroup) null);
        ...
        ((TextView) certificateView.findViewById(16909208)).setText(getSerialNumber(this.mX509Certificate));
        ...
        ((TextView) certificateView.findViewById(16909217)).setText(formatCertificateDate(context, getValidNotBeforeDate()));
        ((TextView) certificateView.findViewById(16909219)).setText(formatCertificateDate(context, getValidNotAfterDate()));
        ((TextView) certificateView.findViewById(16909222)).setText(getDigest(this.mX509Certificate, "SHA256"));
        ((TextView) certificateView.findViewById(16909224)).setText(getDigest(this.mX509Certificate, "SHA1"));
