...
public final class NsdManager {
    ...
    public void registerService(NsdServiceInfo serviceInfo, int protocolType, RegistrationListener listener) {
        if (TextUtils.isEmpty(serviceInfo.getServiceName()) || TextUtils.isEmpty(serviceInfo.getServiceType())) {
            ...
            this.mAsyncChannel.sendMessage((int) REGISTER_SERVICE, 0, key, serviceInfo);
        }
    }
    ...
    public void unregisterService(RegistrationListener listener) {
        ...
        if (id == 0) {
            ...
            this.mAsyncChannel.sendMessage((int) UNREGISTER_SERVICE, 0, id);
        }
    }
    ...
    public void discoverServices(String serviceType, int protocolType, DiscoveryListener listener) {
        if (listener == null) {
            ...
            this.mAsyncChannel.sendMessage((int) DISCOVER_SERVICES, 0, key, s);
        }
    }
    ...
    public void stopServiceDiscovery(DiscoveryListener listener) {
        ...
        if (id == 0) {
            ...
            this.mAsyncChannel.sendMessage((int) STOP_DISCOVERY, 0, id);
        }
    }
    ...
    public void resolveService(NsdServiceInfo serviceInfo, ResolveListener listener) {
        if (TextUtils.isEmpty(serviceInfo.getServiceName()) || TextUtils.isEmpty(serviceInfo.getServiceType())) {
            ...
            this.mAsyncChannel.sendMessage((int) RESOLVE_SERVICE, 0, key, serviceInfo);
        }
    }
