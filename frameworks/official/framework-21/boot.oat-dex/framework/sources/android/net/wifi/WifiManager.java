...
public class WifiManager {
    ...
    public void getTxPacketCount(TxPacketCountListener listener) {
        validateChannel();
        sAsyncChannel.sendMessage((int) RSSI_PKTCNT_FETCH, 0, putListener(listener));
    }
    ...
    public void connect(WifiConfiguration config, ActionListener listener) {
        ...
        validateChannel();
        sAsyncChannel.sendMessage((int) CONNECT_NETWORK, -1, putListener(listener), config);
    }
    ...
    public void connect(int networkId, ActionListener listener) {
        ...
        validateChannel();
        sAsyncChannel.sendMessage((int) CONNECT_NETWORK, networkId, putListener(listener));
    }
    ...
    public void save(WifiConfiguration config, ActionListener listener) {
        ...
        validateChannel();
        sAsyncChannel.sendMessage((int) SAVE_NETWORK, 0, putListener(listener), config);
    }
    ...
    public void forget(int netId, ActionListener listener) {
        ...
        validateChannel();
        sAsyncChannel.sendMessage((int) FORGET_NETWORK, netId, putListener(listener));
    }
    ...
    public void disable(int netId, ActionListener listener) {
        ...
        validateChannel();
        sAsyncChannel.sendMessage((int) DISABLE_NETWORK, netId, putListener(listener));
    }
    ...
    public void startWps(WpsInfo config, WpsCallback listener) {
        ...
        validateChannel();
        sAsyncChannel.sendMessage((int) START_WPS, 0, putListener(listener), config);
    }

    public void cancelWps(WpsCallback listener) {
        validateChannel();
        sAsyncChannel.sendMessage((int) CANCEL_WPS, 0, putListener(listener));
    }
