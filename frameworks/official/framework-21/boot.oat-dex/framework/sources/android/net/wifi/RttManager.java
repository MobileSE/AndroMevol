...
public class RttManager {
    ...
    public void startRanging(RttParams[] params, RttListener listener) {
        validateChannel();
        sAsyncChannel.sendMessage(160256, 0, putListener(listener), new ParcelableRttParams(params));
    }

    public void stopRanging(RttListener listener) {
        validateChannel();
        sAsyncChannel.sendMessage((int) CMD_OP_STOP_RANGING, 0, removeListener(listener));
    }
    ...
    public static class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                default:
                    ...
                    switch (msg.what) {
                        case RttManager.CMD_OP_FAILED /*{ENCODED_INT: 160258}*/:
                            reportFailure(listener, msg);
                            RttManager.removeListener(msg.arg2);
                            return;
                        case RttManager.CMD_OP_SUCCEEDED /*{ENCODED_INT: 160259}*/:
                            reportSuccess(listener, msg);
                            RttManager.removeListener(msg.arg2);
                            return;
                        case RttManager.CMD_OP_ABORTED /*{ENCODED_INT: 160260}*/:
        ...
        public void reportSuccess(Object listener, Message msg) {
            RttListener rttListener = (RttListener) listener;
            ((RttListener) listener).onSuccess(((ParcelableRttResults) msg.obj).mResults);
        }

        /* access modifiers changed from: package-private */
        public void reportFailure(Object listener, Message msg) {
            RttListener rttListener = (RttListener) listener;
            ((RttListener) listener).onFailure(msg.arg1, ((Bundle) msg.obj).getString(RttManager.DESCRIPTION_KEY));
        }
    }
}
