        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    NetworkStats _result = getSummaryForNetwork(_arg04, data.readLong(), data.readLong());
                ...
                case 2:
                    ...
                    NetworkStatsHistory _result2 = getHistoryForNetwork(_arg03, data.readInt());
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
                ...
                case 3:
                    ...
                    NetworkStats _result3 = getSummaryForAllUid(_arg02, data.readLong(), data.readLong(), data.readInt() != 0);
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                ...
                case 4:
                    ...
                    NetworkStatsHistory _result4 = getHistoryForUid(_arg0, data.readInt(), data.readInt(), data.readInt(), data.readInt());
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
